...
// this file has been automatically generated from 'D:/work/soulng/spg/ParserFileParser.parser' using soulng parser generator spg version 1.0.0
                    ...
                    if (match.hit)
                    {
                        ...
                        soulng::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    grammarParser.reset(new soulng::spg::GrammarParser(lexer.GetMatch(span)));
                                }
                                *parentMatch6 = match;
                            }
                            *parentMatch5 = match;
