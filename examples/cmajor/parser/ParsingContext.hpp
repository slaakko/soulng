...
#ifndef CMAJOR_PARSER_PARSING_CONTEXT_HPP
#define CMAJOR_PARSER_PARSING_CONTEXT_HPP
#include <cmajor/parser/ParserApi.hpp>
#include <stack>

struct CMAJOR_PARSER_API ParsingContext
{
    ParsingContext();
...
#endif // CMAJOR_PARSER_PARSING_CONTEXT_HPP
