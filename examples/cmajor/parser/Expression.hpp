...
// this file has been automatically generated from 'D:/work/soulng-project/examples/cmajor/parser/Expression.parser' using soulng parser generator spg version 1.1.0

class CmajorLexer;

struct CMAJOR_PARSER_API ExpressionParser
{
    ...
    static soulng::parser::Match ArgumentList(CmajorLexer& lexer, ParsingContext* ctx, cmajor::ast::Node* node);
    static soulng::parser::Match ExpressionList(CmajorLexer& lexer, ParsingContext* ctx, cmajor::ast::Node* node);
