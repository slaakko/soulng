...
class CMAJOR_AST_API EnumTypeNode : public Node
{
public:
...
class CMAJOR_AST_API EnumConstantNode : public Node
{
public:
...
CMAJOR_AST_API Node* MakeNextEnumConstantValue(const Span& span, EnumTypeNode* enumType);
