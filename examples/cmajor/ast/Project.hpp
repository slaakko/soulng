...
CMAJOR_AST_API std::string CmajorRootDir();
CMAJOR_AST_API std::string CmajorSystemLibDir(const std::string& config, BackEnd backend);
CMAJOR_AST_API std::string CmajorSystemModuleFilePath(const std::string& config, BackEnd backend);
CMAJOR_AST_API void SetOutDir(const std::string& outDir_);
CMAJOR_AST_API const std::string& OutDir();
...
class CMAJOR_AST_API ProjectDeclaration
{
public:
...
class CMAJOR_AST_API ReferenceDeclaration : public ProjectDeclaration
{
public:
...
class CMAJOR_AST_API SourceFileDeclaration : public ProjectDeclaration
{
public:
...
class CMAJOR_AST_API TextFileDeclaration : public ProjectDeclaration
{
public:
...
class CMAJOR_AST_API TargetDeclaration : public ProjectDeclaration
{
public:
