#include "ParserDeclarationParser.hpp"
...
soulng::parser::Match ParserDeclarationParser::BlockDeclaration(ParserFileLexer& lexer)
{
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soulng::parser::Match match = ParserDeclarationParser::NamespaceAliasDefinition(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = ParserDeclarationParser::UsingDirective(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = ParserDeclarationParser::UsingDeclaration(lexer);
...
soulng::parser::Match ParserDeclarationParser::SimpleDeclaration(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            soulng::parser::Match match = ParserDeclarationParser::DeclSpecifierSeq(lexer, simpleDeclaration.get());
                            *parentMatch6 = match;
                        }
                        if (match.hit)
                        {
            ...
            soulng::parser::Match* parentMatch7 = &match;
            {
                ...
                soulng::parser::Match* parentMatch8 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch9 = &match;
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = ParserDeclaratorParser::InitDeclaratorList(lexer);
...
soulng::parser::Match ParserDeclarationParser::DeclSpecifierSeq(ParserFileLexer& lexer, soulng::cppcode::SimpleDeclaration* declaration)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserDeclarationParser::DeclSpecifier(lexer);
...
soulng::parser::Match ParserDeclarationParser::DeclSpecifier(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            {
                int64_t pos = lexer.GetPos();
                soulng::parser::Match match = ParserDeclarationParser::StorageClassSpecifier(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserDeclarationParser::Typedef(lexer);
...
soulng::parser::Match ParserDeclarationParser::StorageClassSpecifier(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserDeclarationParser::TypeSpecifier(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserDeclarationParser::SimpleTypeSpecifier(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserDeclarationParser::TypeName(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch7 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soulng::parser::Match* parentMatch10 = &match;
                                    {
                                        soulng::parser::Match match = ParserDeclarationParser::TemplateArgumentList(lexer, typeName.get());
                                        *parentMatch10 = match;
                                    }
                                    *parentMatch8 = match;
                                }
...
soulng::parser::Match ParserDeclarationParser::TemplateArgumentList(ParserFileLexer& lexer, soulng::cppcode::TypeName* typeName)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            int64_t pos = lexer.GetPos();
            soulng::parser::Match match = ParserDeclarationParser::TemplateArgument(lexer);
...
soulng::parser::Match ParserDeclarationParser::TemplateArgument(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserDeclarationParser::Typedef(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserDeclarationParser::CVQualifier(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserDeclarationParser::NamespaceAliasDefinition(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                soulng::parser::Match match = ParserIdentifierParser::CppIdentifier(lexer);
...
soulng::parser::Match ParserDeclarationParser::UsingDeclaration(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserDeclarationParser::UsingDirective(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
