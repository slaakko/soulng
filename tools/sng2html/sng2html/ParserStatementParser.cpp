#include "ParserStatementParser.hpp"
...
// this file has been automatically generated from 'D:/work/soulng-project/tools/sng2html/sng2html/ParserStatementParser.parser' using soulng parser generator spg version 3.0.0

using namespace soulng::unicode;
using namespace soulng::lexer;
using namespace ParserFileTokens;

soulng::parser::Match ParserStatementParser::Statement(ParserFileLexer& lexer)
{
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch8 = &match;
                                    {
                                        ...
                                        soulng::parser::Match match = ParserStatementParser::LabeledStatement(lexer);
                                    ...
                                    *parentMatch7 = match;
                                    if (!match.hit)
                                    {
                                        ...
                                        lexer.SetPos(save);
                                        {
                                            ...
                                            {
                                                int64_t pos = lexer.GetPos();
                                                soulng::parser::Match match = ParserStatementParser::EmptyStatement(lexer);
                            ...
                            *parentMatch5 = match;
                            if (!match.hit)
                            {
                                ...
                                lexer.SetPos(save);
                                {
                                    ...
                                    {
                                        int64_t pos = lexer.GetPos();
                                        soulng::parser::Match match = ParserStatementParser::SelectionStatement(lexer);
                        ...
                        *parentMatch4 = match;
                        if (!match.hit)
                        {
                            ...
                            lexer.SetPos(save);
                            {
                                ...
                                {
                                    int64_t pos = lexer.GetPos();
                                    soulng::parser::Match match = ParserStatementParser::IterationStatement(lexer);
                    ...
                    *parentMatch3 = match;
                    if (!match.hit)
                    {
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::parser::Match match = ParserStatementParser::JumpStatement(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = ParserStatementParser::DeclarationStatement(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = ParserStatementParser::TryStatement(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserStatementParser::ExpressionStatement(lexer);
...
soulng::parser::Match ParserStatementParser::LabeledStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch6 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch7 = &match;
                    {
                        ...
                        {
                            soulng::lexer::Span span = lexer.GetSpan();
                            soulng::parser::Match match = ParserStatementParser::Statement(lexer);
...
soulng::parser::Match ParserStatementParser::EmptyStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserStatementParser::CompoundStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserStatementParser::SelectionStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            int64_t pos = lexer.GetPos();
            soulng::parser::Match match = ParserStatementParser::IfStatement(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserStatementParser::SwitchStatement(lexer);
...
soulng::parser::Match ParserStatementParser::IfStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            soulng::parser::Match* parentMatch9 = &match;
                            {
                                ...
                                {
                                    soulng::lexer::Span span = lexer.GetSpan();
                                    soulng::parser::Match match = ParserStatementParser::Condition(lexer);
...
soulng::parser::Match ParserStatementParser::SwitchStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserStatementParser::IterationStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserStatementParser::WhileStatement(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = ParserStatementParser::DoStatement(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = ParserStatementParser::RangeForStatement(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserStatementParser::ForStatement(lexer);
...
soulng::parser::Match ParserStatementParser::WhileStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserStatementParser::DoStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserStatementParser::RangeForStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        ...
                        soulng::parser::Match* parentMatch7 = &match;
                        {
                            soulng::parser::Match match = ParserStatementParser::ForRangeDeclaration(lexer);
...
soulng::parser::Match ParserStatementParser::ForRangeDeclaration(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        soulng::parser::Match match = ParserDeclaratorParser::TypeSpecifierSeq(lexer, forRangeDeclaration->GetTypeId());
                        *parentMatch5 = match;
                    }
                    *parentMatch3 = match;
                }
...
soulng::parser::Match ParserStatementParser::ForStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            soulng::parser::Match* parentMatch8 = &match;
                            {
                                soulng::parser::Match match = ParserStatementParser::ForInitStatement(lexer);
...
soulng::parser::Match ParserStatementParser::ForInitStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserDeclarationParser::SimpleDeclaration(lexer);
...
soulng::parser::Match ParserStatementParser::JumpStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserStatementParser::BreakStatement(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = ParserStatementParser::ContinueStatement(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = ParserStatementParser::ReturnStatement(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserStatementParser::GotoStatement(lexer);
...
soulng::parser::Match ParserStatementParser::BreakStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserStatementParser::ContinueStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserStatementParser::ReturnStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserStatementParser::GotoStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserStatementParser::DeclarationStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        int64_t pos = lexer.GetPos();
        soulng::parser::Match match = ParserDeclarationParser::BlockDeclaration(lexer);
...
soulng::parser::Match ParserStatementParser::Condition(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserStatementParser::TryStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch6 = &match;
                {
                    ...
                    {
                        soulng::lexer::Span span = lexer.GetSpan();
                        soulng::parser::Match match = ParserStatementParser::HandlerSeq(lexer, tryStatement.get());
                        if (match.hit)
                        {
                            *parentMatch7 = match;
                        }
...
soulng::parser::Match ParserStatementParser::HandlerSeq(ParserFileLexer& lexer, soulng::cppcode::TryStatement* tryStatement)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            {
                soulng::lexer::Span span = lexer.GetSpan();
                soulng::parser::Match match = ParserStatementParser::Handler(lexer);
    ...
    if (match.hit)
    {
        ...
        soulng::parser::Match* parentMatch3 = &match;
        {
            ...
            soulng::parser::Match* parentMatch4 = &match;
            {
                soulng::parser::Match match = ParserStatementParser::HandlerSeq(lexer, tryStatement);
                if (match.hit)
                {
                    *parentMatch4 = match;
                }
...
soulng::parser::Match ParserStatementParser::Handler(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch6 = &match;
                {
                    ...
                    {
                        soulng::lexer::Span span = lexer.GetSpan();
                        soulng::parser::Match match = ParserStatementParser::ExceptionDeclaration(lexer);
...
soulng::parser::Match ParserStatementParser::ExceptionDeclaration(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soulng::parser::Match* parentMatch3 = &match;
            {
                ...
                soulng::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            soulng::parser::Match match = ParserDeclaratorParser::TypeSpecifierSeq(lexer, exceptionDeclaration->GetTypeId());
                            *parentMatch6 = match;
                        }
                        if (match.hit)
                        {
                                            ...
                                            *parentMatch10 = match;
                                            if (!match.hit)
                                            {
                                                ...
                                                lexer.SetPos(save);
                                                {
                                                    ...
                                                    {
                                                        int64_t pos = lexer.GetPos();
                                                        soulng::parser::Match match = ParserDeclaratorParser::AbstractDeclarator(lexer);
...
soulng::parser::Match ParserStatementParser::ExpressionStatement(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
