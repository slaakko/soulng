...
#include <sng2html/sng2html/LexerStatementParser.hpp>
#include <sng2html/sng2html/LexerFileLexer.hpp>
#include <sng2html/sng2html/LexerFileTokens.hpp>

// this file has been automatically generated from 'D:/work/soulng-project/tools/sng2html/sng2html/LexerFileParser.parser' using soulng parser generator spg version 3.0.0

using namespace soulng::unicode;
using namespace soulng::lexer;
using namespace LexerFileTokens;

std::unique_ptr<sng2html::sng2html::LexerFile> LexerFileParser::Parse(LexerFileLexer& lexer)
{
    std::unique_ptr<sng2html::sng2html::LexerFile> value;
    ...
    value.reset(static_cast<sng2html::sng2html::LexerFile*>(match.value));
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    if (lexer.Log())
    {
        lexer.Log()->DecIndent();
    ...
    {
        lexer.ThrowExpectationFailure(span, U"lexer file");
    }
    return value;
}
...
soulng::parser::Match LexerFileParser::LexerFile(LexerFileLexer& lexer)
{
    ...
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    std::unique_ptr<sng2html::sng2html::LexerFile> lexerFile = std::unique_ptr<sng2html::sng2html::LexerFile>();
    std::unique_ptr<sng2html::sng2html::Declaration> declaration;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                lexerFile.reset(new sng2html::sng2html::LexerFile);
            }
            *parentMatch1 = match;
        }
        *parentMatch0 = match;
                            ...
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        declaration.reset(static_cast<sng2html::sng2html::Declaration*>(match.value));
                                        if (match.hit)
                                        {
...
soulng::parser::Match LexerFileParser::Declaration(LexerFileLexer& lexer)
{
    ...
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    std::unique_ptr<sng2html::sng2html::ClassMap> classMapDeclaration;
    std::unique_ptr<sng2html::sng2html::Prefix> prefixDeclaration;
    std::unique_ptr<sng2html::sng2html::IncludeDeclaration> includeDeclaration;
    std::unique_ptr<sng2html::sng2html::Tokens> tokensDeclaration;
    std::unique_ptr<sng2html::sng2html::Keywords> keywordsDeclaration;
    std::unique_ptr<sng2html::sng2html::Expressions> expressionsDeclaration;
    std::unique_ptr<sng2html::sng2html::Lexer> lexerDeclaration;
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
        int64_t save = lexer.GetPos();
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                classMapDeclaration.reset(static_cast<sng2html::sng2html::ClassMap*>(match.value));
                                if (match.hit)
                                {
                                    {
                                        #ifdef SOULNG_PARSER_DEBUG_SUPPORT
                            ...
                            if (!match.hit)
                            {
                                ...
                                lexer.SetPos(save);
                                {
                                    ...
                                    soulng::parser::Match* parentMatch8 = &match;
                                    {
                                        ...
                                        prefixDeclaration.reset(static_cast<sng2html::sng2html::Prefix*>(match.value));
                                        if (match.hit)
                                        {
                                            {
                                                #ifdef SOULNG_PARSER_DEBUG_SUPPORT
                        ...
                        if (!match.hit)
                        {
                            ...
                            lexer.SetPos(save);
                            {
                                ...
                                soulng::parser::Match* parentMatch10 = &match;
                                {
                                    ...
                                    includeDeclaration.reset(static_cast<sng2html::sng2html::IncludeDeclaration*>(match.value));
                                    if (match.hit)
                                    {
                                        {
                                            #ifdef SOULNG_PARSER_DEBUG_SUPPORT
                    ...
                    if (!match.hit)
                    {
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            soulng::parser::Match* parentMatch12 = &match;
                            {
                                ...
                                tokensDeclaration.reset(static_cast<sng2html::sng2html::Tokens*>(match.value));
                                if (match.hit)
                                {
                                    {
                                        #ifdef SOULNG_PARSER_DEBUG_SUPPORT
                ...
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        soulng::parser::Match* parentMatch14 = &match;
                        {
                            ...
                            keywordsDeclaration.reset(static_cast<sng2html::sng2html::Keywords*>(match.value));
                            if (match.hit)
                            {
                                {
                                    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
            ...
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    soulng::parser::Match* parentMatch16 = &match;
                    {
                        ...
                        expressionsDeclaration.reset(static_cast<sng2html::sng2html::Expressions*>(match.value));
                        if (match.hit)
                        {
                            {
                                #ifdef SOULNG_PARSER_DEBUG_SUPPORT
        ...
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                soulng::parser::Match* parentMatch18 = &match;
                {
                    ...
                    lexerDeclaration.reset(static_cast<sng2html::sng2html::Lexer*>(match.value));
                    if (match.hit)
                    {
                        {
                            #ifdef SOULNG_PARSER_DEBUG_SUPPORT
                ...
                {
                    {
                        ...
                        #endif // SOULNG_PARSER_DEBUG_SUPPORT
                        return soulng::parser::Match(true, new sng2html::sng2html::ClassMap(classMapName));
                    }
                }
                *parentMatch6 = match;
            }
                ...
                {
                    {
                        ...
                        #endif // SOULNG_PARSER_DEBUG_SUPPORT
                        return soulng::parser::Match(true, new sng2html::sng2html::Prefix(U""));
                    }
                }
                *parentMatch5 = match;
            }
                ...
                {
                    {
                        ...
                        #endif // SOULNG_PARSER_DEBUG_SUPPORT
                        return soulng::parser::Match(true, new sng2html::sng2html::IncludeDeclaration(U""));
                    }
                }
                *parentMatch4 = match;
            }
...
soulng::parser::Match LexerFileParser::Tokens(LexerFileLexer& lexer)
{
    ...
    std::unique_ptr<sng2html::sng2html::Tokens> tokens = std::unique_ptr<sng2html::sng2html::Tokens>();
    std::unique_ptr<soulng::parser::Value<sng2html::sng2html::Token>> token;
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
        soulng::parser::Match match(false);
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch7 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch8 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            tokens.reset(new sng2html::sng2html::Tokens(tokensDeclarationName));
                        }
                        *parentMatch8 = match;
                    }
                    *parentMatch7 = match;
                    ...
                    soulng::parser::Match* parentMatch12 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch13 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch14 = &match;
                            {
                                ...
                                token.reset(static_cast<soulng::parser::Value<sng2html::sng2html::Token>*>(match.value));
                                if (match.hit)
                                {
        ...
        if (match.hit)
        {
            ...
            soulng::parser::Match* parentMatch9 = &match;
            {
                ...
                soulng::parser::Match* parentMatch10 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        tokenInfo = sng2html::sng2html::MakeStrValue(lexer.FileName(), lexer.GetToken(pos));
                    }
                    *parentMatch10 = match;
                }
                *parentMatch9 = match;
                ...
                {
                    {
                        ...
                        #endif // SOULNG_PARSER_DEBUG_SUPPORT
                        return soulng::parser::Match(true, new soulng::parser::Value<sng2html::sng2html::Token>(sng2html::sng2html::Token(tokenName, ToUtf8(tokenInfo))));
                    }
                }
                *parentMatch13 = match;
            }
...
soulng::parser::Match LexerFileParser::Keywords(LexerFileLexer& lexer)
{
    ...
    std::unique_ptr<sng2html::sng2html::Keywords> keywords = std::unique_ptr<sng2html::sng2html::Keywords>();
    std::unique_ptr<sng2html::sng2html::Keyword> keyword;
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
        soulng::parser::Match match(false);
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch7 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch8 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            keywords.reset(new sng2html::sng2html::Keywords(keywordsDeclarationName));
                        }
                        *parentMatch8 = match;
                    }
                    *parentMatch7 = match;
                    ...
                    soulng::parser::Match* parentMatch12 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch13 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch14 = &match;
                            {
                                ...
                                keyword.reset(static_cast<sng2html::sng2html::Keyword*>(match.value));
                                if (match.hit)
                                {
                ...
                if (match.hit)
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                kw = sng2html::sng2html::MakeStrValue(lexer.FileName(), lexer.GetToken(pos));
                            }
                            *parentMatch5 = match;
                        }
                        *parentMatch4 = match;
                ...
                {
                    {
                        ...
                        #endif // SOULNG_PARSER_DEBUG_SUPPORT
                        return soulng::parser::Match(true, new sng2html::sng2html::Keyword(kw, tokenName));
                    }
                }
                *parentMatch13 = match;
            }
...
soulng::parser::Match LexerFileParser::Expressions(LexerFileLexer& lexer)
{
    ...
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    int index = int();
    std::unique_ptr<sng2html::sng2html::Expressions> expressions = std::unique_ptr<sng2html::sng2html::Expressions>();
    std::unique_ptr<sng2html::sng2html::Expression> expr;
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
        soulng::parser::Match match(false);
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    {
                        index = 0;
                        expressions.reset(new sng2html::sng2html::Expressions);
                    }
                    *parentMatch3 = match;
                }
                *parentMatch2 = match;
                        ...
                        int64_t save = lexer.GetPos();
                        {
                            ...
                            soulng::parser::Match* parentMatch8 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch9 = &match;
                                {
                                    ...
                                    expr.reset(static_cast<sng2html::sng2html::Expression*>(match.value));
                                    if (match.hit)
                                    {
            ...
            soulng::parser::Match* parentMatch5 = &match;
            {
                ...
                soulng::parser::Match* parentMatch6 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch7 = &match;
                    {
                        ...
                        {
                            lexer.ThrowExpectationFailure(span, U"regular expression string");
                        }
                    }
                    if (match.hit)
                    {
                ...
                {
                    {
                        ...
                        #endif // SOULNG_PARSER_DEBUG_SUPPORT
                        return soulng::parser::Match(true, new sng2html::sng2html::Expression(index, exprName, exprValue->value, line));
                    }
                }
                *parentMatch9 = match;
            }
        ...
        {
            {
                ...
                #endif // SOULNG_PARSER_DEBUG_SUPPORT
                return soulng::parser::Match(true, new soulng::parser::Value<std::u32string>(sng2html::sng2html::MakeExprStringValue(lexer.FileName(), lexer.GetToken(pos))));
            }
        }
        *parentMatch0 = match;
    }
...
soulng::parser::Match LexerFileParser::Lexer(LexerFileLexer& lexer)
{
    ...
    std::unique_ptr<sng2html::sng2html::Lexer> currentLexer = std::unique_ptr<sng2html::sng2html::Lexer>();
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch9 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch10 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            currentLexer.reset(new sng2html::sng2html::Lexer(lexerApi->value, lexerDeclarationName));
                        }
                        *parentMatch10 = match;
                    }
                    *parentMatch9 = match;
...
soulng::parser::Match LexerFileParser::LexerClause(LexerFileLexer& lexer, sng2html::sng2html::Lexer* currentLexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    currentLexer->AddStatement(new sng2html::sng2html::LexerStatement(expr->value, stmt.release(), action->value, line));
                }
                *parentMatch2 = match;
            }
            *parentMatch1 = match;
...
soulng::parser::Match LexerFileParser::Variables(LexerFileLexer& lexer, sng2html::sng2html::Lexer* currentLexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    std::unique_ptr<sng2html::sng2html::LexerVariable> variable;
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
        soulng::parser::Match match(false);
                        ...
                        int64_t save = lexer.GetPos();
                        {
                            ...
                            soulng::parser::Match* parentMatch7 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch8 = &match;
                                {
                                    ...
                                    variable.reset(static_cast<sng2html::sng2html::LexerVariable*>(match.value));
                                    if (match.hit)
                                    {
                ...
                {
                    {
                        ...
                        #endif // SOULNG_PARSER_DEBUG_SUPPORT
                        return soulng::parser::Match(true, new sng2html::sng2html::LexerVariable(type.release(), name));
                    }
                }
                *parentMatch5 = match;
            }
...
soulng::parser::Match LexerFileParser::Actions(LexerFileLexer& lexer, sng2html::sng2html::Lexer* currentLexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                        ...
                        int64_t save = lexer.GetPos();
                        {
                            ...
                            soulng::parser::Match* parentMatch7 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch8 = &match;
                                {
                                    ...
                                    if (match.hit)
                                    {
                                        currentLexer->AddAction(new sng2html::sng2html::Action(action->value, stmt.release()));
                                    }
                                    *parentMatch8 = match;
                                }
                                *parentMatch7 = match;
                        ...
                        soulng::parser::Match* parentMatch8 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch9 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch10 = &match;
                                {
                                    ...
                                    {
                                        lexer.ThrowExpectationFailure(span, ToUtf32(GetTokenInfo(INTLIT)));
                                    }
                                }
                                if (match.hit)
                                {
                                    actionId = sng2html::sng2html::MakeActionIntValue(lexer.FileName(), lexer.GetToken(pos));
                                }
                                *parentMatch9 = match;
                            }
                            *parentMatch8 = match;
