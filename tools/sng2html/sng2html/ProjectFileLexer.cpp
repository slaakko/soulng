...
#include <sng2html/sng2html/ProjectFileKeywords.hpp>
#include <soulng/lexer/Token.hpp>
#include <sng2html/sng2html/ProjectFileTokens.hpp>
#include <sng2html/sng2html/ProjectFileClassMap.hpp>
...
int ProjectFileLexer::GetTokenId(int statementIndex)
{
    switch (statementIndex)
    {
        ...
        {
            Retract();
            filePath = sng2html::sng2html::MakeFilePath(FileName(), token);
            return FILEPATH;
            break;
        }
        case 3:
