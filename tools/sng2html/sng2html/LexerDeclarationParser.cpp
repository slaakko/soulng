#include "LexerDeclarationParser.hpp"
...
// this file has been automatically generated from 'C:/work/soulng/tools/sng2html/sng2html/LexerDeclarationParser.parser' using soulng parser generator spg version 4.0.0

using namespace soulng::unicode;
using namespace soulng::lexer;
using namespace LexerFileTokens;

soulng::parser::Match LexerDeclarationParser::BlockDeclaration(LexerFileLexer& lexer)
{
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soulng::parser::Match match = LexerDeclarationParser::NamespaceAliasDefinition(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = LexerDeclarationParser::UsingDirective(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = LexerDeclarationParser::UsingDeclaration(lexer);
...
soulng::parser::Match LexerDeclarationParser::SimpleDeclaration(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            soulng::parser::Match match = LexerDeclarationParser::DeclSpecifierSeq(lexer, simpleDeclaration.get());
                            *parentMatch6 = match;
                        }
                        if (match.hit)
                        {
            ...
            soulng::parser::Match* parentMatch7 = &match;
            {
                ...
                soulng::parser::Match* parentMatch8 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch9 = &match;
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = LexerDeclaratorParser::InitDeclaratorList(lexer);
...
soulng::parser::Match LexerDeclarationParser::DeclSpecifierSeq(LexerFileLexer& lexer, soulng::cppcode::SimpleDeclaration* declaration)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerDeclarationParser::DeclSpecifier(lexer);
...
soulng::parser::Match LexerDeclarationParser::DeclSpecifier(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            {
                int64_t pos = lexer.GetPos();
                soulng::parser::Match match = LexerDeclarationParser::StorageClassSpecifier(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = LexerDeclarationParser::TypeSpecifier(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerDeclarationParser::Typedef(lexer);
...
soulng::parser::Match LexerDeclarationParser::StorageClassSpecifier(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerDeclarationParser::TypeSpecifier(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerDeclarationParser::CVQualifier(lexer);
...
soulng::parser::Match LexerDeclarationParser::SimpleTypeSpecifier(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerDeclarationParser::TypeName(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch7 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soulng::parser::Match* parentMatch10 = &match;
                                    {
                                        soulng::parser::Match match = LexerDeclarationParser::TemplateArgumentList(lexer, typeName.get());
                                        *parentMatch10 = match;
                                    }
                                    *parentMatch8 = match;
                                }
...
soulng::parser::Match LexerDeclarationParser::TemplateArgumentList(LexerFileLexer& lexer, soulng::cppcode::TypeName* typeName)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            int64_t pos = lexer.GetPos();
            soulng::parser::Match match = LexerDeclarationParser::TemplateArgument(lexer);
...
soulng::parser::Match LexerDeclarationParser::TemplateArgument(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerDeclarationParser::Typedef(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerDeclarationParser::CVQualifier(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerDeclarationParser::NamespaceAliasDefinition(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                soulng::parser::Match match = LexerIdentifierParser::CppIdentifier(lexer);
...
soulng::parser::Match LexerDeclarationParser::UsingDeclaration(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerDeclarationParser::UsingDirective(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
