...
std::unique_ptr<sng2html::sng2html::ProjectFile> ProjectFileParser::Parse(ProjectFileLexer& lexer)
{
    std::unique_ptr<sng2html::sng2html::ProjectFile> value;
    ...
    value.reset(static_cast<sng2html::sng2html::ProjectFile*>(match.value));
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    if (lexer.Log())
    {
        lexer.Log()->DecIndent();
...
soulng::parser::Match ProjectFileParser::ProjectFile(ProjectFileLexer& lexer)
{
    ...
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    std::unique_ptr<sng2html::sng2html::ProjectFile> projectFile = std::unique_ptr<sng2html::sng2html::ProjectFile>();
        ...
        if (match.hit)
        {
            ...
            soulng::parser::Match* parentMatch5 = &match;
            {
                ...
                soulng::parser::Match* parentMatch6 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        projectFile.reset(new sng2html::sng2html::ProjectFile(lexer.FileName(), projectName->value));
                    }
                    *parentMatch6 = match;
                }
                *parentMatch5 = match;
...
soulng::parser::Match ProjectFileParser::ProjectFileContent(ProjectFileLexer& lexer, sng2html::sng2html::ProjectFile* projectFile)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ProjectFileParser::SourceFile(ProjectFileLexer& lexer, sng2html::sng2html::ProjectFile* projectFile)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
