#include "LexerIdentifierParser.hpp"
...
soulng::parser::Match LexerIdentifierParser::CppIdentifier(LexerFileLexer& lexer)
{
...
soulng::parser::Match LexerIdentifierParser::QualifiedCppId(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
