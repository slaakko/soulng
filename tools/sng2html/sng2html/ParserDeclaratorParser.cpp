#include "ParserDeclaratorParser.hpp"
...
// this file has been automatically generated from 'C:/work/soulng/tools/sng2html/sng2html/ParserDeclaratorParser.parser' using soulng parser generator spg version 4.0.0

using namespace soulng::unicode;
using namespace soulng::lexer;
using namespace ParserFileTokens;

soulng::parser::Match ParserDeclaratorParser::InitDeclaratorList(ParserFileLexer& lexer)
{
                ...
                soulng::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::parser::Match match = ParserDeclaratorParser::InitDeclarator(lexer);
...
soulng::parser::Match ParserDeclaratorParser::InitDeclarator(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        soulng::parser::Match match = ParserDeclaratorParser::Initializer(lexer);
...
soulng::parser::Match ParserDeclaratorParser::Declarator(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soulng::parser::Match match = ParserDeclaratorParser::DirectDeclarator(lexer);
                    if (match.hit)
                    {
                        s = span;
                    }
...
soulng::parser::Match ParserDeclaratorParser::DirectDeclarator(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        soulng::parser::Match match = ParserDeclaratorParser::DeclaratorId(lexer);
        *parentMatch0 = match;
    }
    if (match.hit)
    {
...
soulng::parser::Match ParserDeclaratorParser::DeclaratorId(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserDeclaratorParser::TypeId(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                soulng::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            {
                                int64_t save = lexer.GetPos();
                                soulng::parser::Match match = ParserDeclaratorParser::TypeSpecifierSeq(lexer, typeId.get());
                                *parentMatch7 = match;
                                if (!match.hit)
                                {
                                    soulng::parser::Match match(false);
...
soulng::parser::Match ParserDeclaratorParser::Type(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch7 = &match;
                            {
                                ...
                                {
                                    int64_t pos = lexer.GetPos();
                                    soulng::parser::Match match = ParserDeclarationParser::TypeSpecifier(lexer);
...
soulng::parser::Match ParserDeclaratorParser::TypeSpecifierSeq(ParserFileLexer& lexer, soulng::cppcode::TypeId* typeId)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserDeclaratorParser::AbstractDeclarator(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        soulng::parser::Match* parentMatch10 = &match;
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::lexer::Span span = lexer.GetSpan();
                            soulng::parser::Match match = ParserDeclaratorParser::DirectAbstractDeclarator(lexer);
                            if (match.hit)
                            {
                                s = span;
                            }
...
soulng::parser::Match ParserDeclaratorParser::DirectAbstractDeclarator(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserDeclaratorParser::PtrOperator(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    soulng::parser::Match match = ParserDeclaratorParser::CVQualifierSeq(lexer);
                    if (match.hit)
                    {
                        *parentMatch3 = match;
                    }
...
soulng::parser::Match ParserDeclaratorParser::CVQualifierSeq(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        soulng::parser::Match match = ParserDeclarationParser::CVQualifier(lexer);
...
soulng::parser::Match ParserDeclaratorParser::Initializer(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = ParserDeclaratorParser::InitializerClause(lexer);
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        soulng::parser::Match* parentMatch7 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                ...
                                soulng::parser::Match* parentMatch10 = &match;
                                {
                                    soulng::parser::Match match = ParserExpressionParser::ExpressionList(lexer, initializer.get());
                                    *parentMatch10 = match;
                                }
                                *parentMatch8 = match;
                            }
...
soulng::parser::Match ParserDeclaratorParser::InitializerClause(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soulng::parser::Match* parentMatch9 = &match;
                                    {
                                        soulng::parser::Match match = ParserDeclaratorParser::InitializerList(lexer, assignInit.get());
                                        *parentMatch9 = match;
                                    }
                                    *parentMatch7 = match;
                                }
...
soulng::parser::Match ParserDeclaratorParser::InitializerList(ParserFileLexer& lexer, soulng::cppcode::AssignInit* init)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
