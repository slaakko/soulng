#include "LexerExpressionParser.hpp"
#include <soulng/util/Unicode.hpp>
#include <soulng/util/TextUtils.hpp>
#include <sng2html/sng2html/LexerDeclaratorParser.hpp>
#include <sng2html/sng2html/LexerDeclarationParser.hpp>
#include <sng2html/sng2html/LexerLiteralParser.hpp>
#include <sng2html/sng2html/LexerIdentifierParser.hpp>
#include <sng2html/sng2html/LexerFileLexer.hpp>
#include <sng2html/sng2html/LexerFileTokens.hpp>

// this file has been automatically generated from 'C:/work/soulng/tools/sng2html/sng2html/LexerExpressionParser.parser' using soulng parser generator spg version 4.0.0

using namespace soulng::unicode;
using namespace soulng::lexer;
using namespace LexerFileTokens;

soulng::parser::Match LexerExpressionParser::CppExpression(LexerFileLexer& lexer)
{
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::AssignmentExpression(lexer);
...
soulng::parser::Match LexerExpressionParser::ConstantExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        int64_t pos = lexer.GetPos();
        soulng::parser::Match match = LexerExpressionParser::CppExpression(lexer);
...
soulng::parser::Match LexerExpressionParser::AssignmentExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    soulng::parser::Match match = LexerExpressionParser::LogicalOrExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    *parentMatch3 = match;
                }
                if (match.hit)
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        soulng::parser::Match match = LexerExpressionParser::AssignmentOp(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = LexerExpressionParser::ConditionalExpression(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::ThrowExpression(lexer);
...
soulng::parser::Match LexerExpressionParser::AssignmentOp(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::ConditionalExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::ThrowExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::LogicalOrExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::LogicalAndExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
...
soulng::parser::Match LexerExpressionParser::LogicalAndExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::InclusiveOrExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
...
soulng::parser::Match LexerExpressionParser::InclusiveOrExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::ExclusiveOrExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
...
soulng::parser::Match LexerExpressionParser::ExclusiveOrExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::AndExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
...
soulng::parser::Match LexerExpressionParser::AndExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::EqualityExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
...
soulng::parser::Match LexerExpressionParser::EqualityExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::RelationalExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = LexerExpressionParser::EqOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match LexerExpressionParser::EqOp(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::RelationalExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::ShiftExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = LexerExpressionParser::RelOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match LexerExpressionParser::RelOp(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::ShiftExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::AdditiveExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = LexerExpressionParser::ShiftOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match LexerExpressionParser::ShiftOp(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::AdditiveExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::MultiplicativeExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = LexerExpressionParser::AddOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match LexerExpressionParser::AddOp(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::MultiplicativeExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::PmExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = LexerExpressionParser::MulOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match LexerExpressionParser::MulOp(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::PmExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerExpressionParser::CastExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = LexerExpressionParser::PmOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match LexerExpressionParser::PmOp(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::CastExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                soulng::parser::Match match = LexerDeclaratorParser::TypeId(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = LexerExpressionParser::UnaryExpression(lexer);
...
soulng::parser::Match LexerExpressionParser::UnaryExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                                ...
                                soulng::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch8 = &match;
                                    {
                                        ...
                                        soulng::parser::Match* parentMatch9 = &match;
                                        {
                                            ...
                                            {
                                                int64_t pos = lexer.GetPos();
                                                soulng::parser::Match match = LexerExpressionParser::PostfixExpression(lexer);
                                            ...
                                            *parentMatch9 = match;
                                            if (!match.hit)
                                            {
                                                ...
                                                lexer.SetPos(save);
                                                {
                                                    ...
                                                    {
                                                        int64_t pos = lexer.GetPos();
                                                        soulng::parser::Match match = LexerExpressionParser::PostCastExpression(lexer);
                                ...
                                *parentMatch6 = match;
                                if (!match.hit)
                                {
                                    ...
                                    lexer.SetPos(save);
                                    {
                                        ...
                                        {
                                            soulng::parser::Match match = LexerExpressionParser::UnaryOperator(lexer);
                                            op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                            *parentMatch24 = match;
                                        }
                                        if (match.hit)
                    ...
                    *parentMatch3 = match;
                    if (!match.hit)
                    {
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::parser::Match match = LexerExpressionParser::NewExpression(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = LexerExpressionParser::DeleteExpression(lexer);
...
soulng::parser::Match LexerExpressionParser::UnaryOperator(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::PostfixExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = LexerExpressionParser::PrimaryExpression(lexer);
                                                                    ...
                                                                    soulng::parser::Match* parentMatch20 = &match;
                                                                    {
                                                                        ...
                                                                        if (match.hit)
                                                                        {
                                                                            ...
                                                                            soulng::parser::Match* parentMatch23 = &match;
                                                                            {
                                                                                ...
                                                                                soulng::parser::Match* parentMatch24 = &match;
                                                                                {
                                                                                    soulng::parser::Match match = LexerExpressionParser::ExpressionList(lexer, expr.get());
                                                                                    if (match.hit)
                                                                                    {
                                                                                        *parentMatch24 = match;
                                                                                    }
                                                                ...
                                                                if (match.hit)
                                                                {
                                                                    ...
                                                                    soulng::parser::Match* parentMatch29 = &match;
                                                                    {
                                                                        ...
                                                                        soulng::parser::Match* parentMatch30 = &match;
                                                                        {
                                                                            ...
                                                                            {
                                                                                soulng::lexer::Span span = lexer.GetSpan();
                                                                                soulng::parser::Match match = LexerExpressionParser::IdExpression(lexer);
                        ...
                        soulng::parser::Match* parentMatch42 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch43 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch44 = &match;
                                {
                                    ...
                                    {
                                        int64_t pos = lexer.GetPos();
                                        soulng::parser::Match match = LexerExpressionParser::TypeSpecifierOrTypeName(lexer);
...
soulng::parser::Match LexerExpressionParser::PostCastExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::ExpressionList(LexerFileLexer& lexer, soulng::cppcode::CppObject* owner)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::PrimaryExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerLiteralParser::CppLiteral(lexer);
...
soulng::parser::Match LexerExpressionParser::IdExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch5 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::lexer::Span span = lexer.GetSpan();
                                soulng::parser::Match match = LexerIdentifierParser::QualifiedCppId(lexer);
                    ...
                    if (match.hit)
                    {
                        ...
                        soulng::parser::Match* parentMatch8 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch9 = &match;
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::lexer::Span span = lexer.GetSpan();
                                soulng::parser::Match match = LexerExpressionParser::OperatorFunctionId(lexer);
...
soulng::parser::Match LexerExpressionParser::TypeSpecifierOrTypeName(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            int64_t pos = lexer.GetPos();
            soulng::parser::Match match = LexerDeclarationParser::SimpleTypeSpecifier(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerDeclarationParser::TypeName(lexer);
...
soulng::parser::Match LexerExpressionParser::NewExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soulng::parser::Match* parentMatch17 = &match;
                                    {
                                        ...
                                        soulng::parser::Match* parentMatch18 = &match;
                                        {
                                            soulng::parser::Match match = LexerExpressionParser::NewPlacement(lexer, newExpr.get());
                                            if (match.hit)
                                            {
                                                *parentMatch18 = match;
                                            }
                            ...
                            soulng::parser::Match* parentMatch21 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch22 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch23 = &match;
                                    {
                                        ...
                                        {
                                            int64_t pos = lexer.GetPos();
                                            soulng::parser::Match match = LexerExpressionParser::NewTypeId(lexer);
                ...
                if (match.hit)
                {
                    ...
                    soulng::parser::Match* parentMatch33 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch34 = &match;
                        {
                            soulng::parser::Match match = LexerExpressionParser::NewInitializer(lexer, newExpr.get());
                            if (match.hit)
                            {
                                *parentMatch34 = match;
                            }
...
soulng::parser::Match LexerExpressionParser::NewPlacement(LexerFileLexer& lexer, soulng::cppcode::CppObject* owner)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                soulng::parser::Match match = LexerExpressionParser::ExpressionList(lexer, owner);
                *parentMatch2 = match;
            }
            *parentMatch1 = match;
        }
...
soulng::parser::Match LexerExpressionParser::NewTypeId(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                soulng::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            {
                                int64_t save = lexer.GetPos();
                                soulng::parser::Match match = LexerDeclaratorParser::TypeSpecifierSeq(lexer, ti.get());
                                *parentMatch7 = match;
                                if (!match.hit)
                                {
                                    soulng::parser::Match match(false);
                        ...
                        soulng::parser::Match* parentMatch10 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch11 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch12 = &match;
                                {
                                    ...
                                    {
                                        int64_t pos = lexer.GetPos();
                                        soulng::parser::Match match = LexerExpressionParser::NewDeclarator(lexer);
...
soulng::parser::Match LexerExpressionParser::NewDeclarator(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch7 = &match;
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::lexer::Span span = lexer.GetSpan();
                                soulng::parser::Match match = LexerDeclaratorParser::PtrOperator(lexer);
                                if (match.hit)
                                {
                                    s.end = span.end;
                                }
                        ...
                        if (!match.hit)
                        {
                            ...
                            lexer.SetPos(save);
                            {
                                ...
                                soulng::parser::Match* parentMatch13 = &match;
                                {
                                    int64_t pos = lexer.GetPos();
                                    soulng::lexer::Span span = lexer.GetSpan();
                                    soulng::parser::Match match = LexerExpressionParser::DirectNewDeclarator(lexer);
                                    if (match.hit)
                                    {
                                        s.end = span.end;
                                    }
...
soulng::parser::Match LexerExpressionParser::NewInitializer(LexerFileLexer& lexer, soulng::cppcode::CppObject* owner)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::DirectNewDeclarator(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                        ...
                        soulng::parser::Match* parentMatch7 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch8 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soulng::parser::Match* parentMatch10 = &match;
                                    {
                                        soulng::parser::Match match = LexerExpressionParser::ConstantExpression(lexer);
...
soulng::parser::Match LexerExpressionParser::DeleteExpression(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerExpressionParser::OperatorFunctionId(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    if (match.hit)
    {
        ...
        soulng::parser::Match* parentMatch2 = &match;
        {
            ...
            soulng::parser::Match* parentMatch3 = &match;
            {
                int64_t pos = lexer.GetPos();
                soulng::lexer::Span span = lexer.GetSpan();
                soulng::parser::Match match = LexerExpressionParser::Operator(lexer);
                if (match.hit)
                {
                    s.end = span.end;
                    {
...
soulng::parser::Match LexerExpressionParser::Operator(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
