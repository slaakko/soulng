#include "LexerDeclaratorParser.hpp"
...
// this file has been automatically generated from 'C:/work/soulng/tools/sng2html/sng2html/LexerDeclaratorParser.parser' using soulng parser generator spg version 4.0.0

using namespace soulng::unicode;
using namespace soulng::lexer;
using namespace LexerFileTokens;

soulng::parser::Match LexerDeclaratorParser::InitDeclaratorList(LexerFileLexer& lexer)
{
                ...
                soulng::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::parser::Match match = LexerDeclaratorParser::InitDeclarator(lexer);
...
soulng::parser::Match LexerDeclaratorParser::InitDeclarator(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        soulng::parser::Match match = LexerDeclaratorParser::Initializer(lexer);
...
soulng::parser::Match LexerDeclaratorParser::Declarator(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soulng::parser::Match match = LexerDeclaratorParser::DirectDeclarator(lexer);
                    if (match.hit)
                    {
                        s = span;
                    }
...
soulng::parser::Match LexerDeclaratorParser::DirectDeclarator(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        soulng::parser::Match match = LexerDeclaratorParser::DeclaratorId(lexer);
        *parentMatch0 = match;
    }
    if (match.hit)
    {
...
soulng::parser::Match LexerDeclaratorParser::DeclaratorId(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerDeclaratorParser::TypeId(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                soulng::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            {
                                int64_t save = lexer.GetPos();
                                soulng::parser::Match match = LexerDeclaratorParser::TypeSpecifierSeq(lexer, typeId.get());
                                *parentMatch7 = match;
                                if (!match.hit)
                                {
                                    soulng::parser::Match match(false);
...
soulng::parser::Match LexerDeclaratorParser::Type(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerDeclaratorParser::TypeSpecifierSeq(LexerFileLexer& lexer, soulng::cppcode::TypeId* typeId)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerDeclaratorParser::AbstractDeclarator(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        soulng::parser::Match* parentMatch10 = &match;
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::lexer::Span span = lexer.GetSpan();
                            soulng::parser::Match match = LexerDeclaratorParser::DirectAbstractDeclarator(lexer);
                            if (match.hit)
                            {
                                s = span;
                            }
...
soulng::parser::Match LexerDeclaratorParser::DirectAbstractDeclarator(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerDeclaratorParser::PtrOperator(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    soulng::parser::Match match = LexerDeclaratorParser::CVQualifierSeq(lexer);
                    if (match.hit)
                    {
                        *parentMatch3 = match;
                    }
...
soulng::parser::Match LexerDeclaratorParser::CVQualifierSeq(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerDeclaratorParser::Initializer(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = LexerDeclaratorParser::InitializerClause(lexer);
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        soulng::parser::Match* parentMatch7 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                ...
                                soulng::parser::Match* parentMatch10 = &match;
                                {
                                    soulng::parser::Match match = LexerExpressionParser::ExpressionList(lexer, initializer.get());
                                    *parentMatch10 = match;
                                }
                                *parentMatch8 = match;
                            }
...
soulng::parser::Match LexerDeclaratorParser::InitializerClause(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soulng::parser::Match* parentMatch9 = &match;
                                    {
                                        soulng::parser::Match match = LexerDeclaratorParser::InitializerList(lexer, assignInit.get());
                                        *parentMatch9 = match;
                                    }
                                    *parentMatch7 = match;
                                }
...
soulng::parser::Match LexerDeclaratorParser::InitializerList(LexerFileLexer& lexer, soulng::cppcode::AssignInit* init)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
