...
#ifndef SNG2HTML_SNG2HTML_PARSER_INCLUDED
#define SNG2HTML_SNG2HTML_PARSER_INCLUDED
...
public:
    ...
    virtual bool IsGrammar() const { return false; }
    virtual bool IsEmptyOrEmptyActionParser() const { return false; }
    virtual bool IsPostfix() const { return false; }
    bool ParentIsList() const { return parentIsList; }
    virtual bool IsList() const { return false; }
    const std::u32string& Name() const { return name; }
    Parser* Parent() const { return parent; }
    void SetParent(Parser* parent_) { parent = parent_; }
    void SetParentIsList() { parentIsList = true; }
private:
    Parser* parent;
    std::u32string name;
    bool parentIsList;
...
public:
    ...
    bool IsEmptyOrEmptyActionParser() const override { return true; }
};
...
public:
    ...
    bool IsEmptyOrEmptyActionParser() const override { return Child()->IsEmptyOrEmptyActionParser(); }
...
public:
    ...
    bool IsGrammar() const override { return true; }
    void Accept(Visitor& visitor) override;
...
#endif // SNG2HTML_SNG2HTML_PARSER_INCLUDED
