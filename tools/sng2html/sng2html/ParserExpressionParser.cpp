#include "ParserExpressionParser.hpp"
#include <soulng/util/Unicode.hpp>
#include <soulng/util/TextUtils.hpp>
#include <sng2html/sng2html/ParserDeclaratorParser.hpp>
#include <sng2html/sng2html/ParserDeclarationParser.hpp>
#include <sng2html/sng2html/ParserLiteralParser.hpp>
...
// this file has been automatically generated from 'D:/work/soulng-project/tools/sng2html/sng2html/ParserExpressionParser.parser' using soulng parser generator spg version 3.0.0

using namespace soulng::unicode;
using namespace soulng::lexer;
using namespace ParserFileTokens;

soulng::parser::Match ParserExpressionParser::CppExpression(ParserFileLexer& lexer)
{
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::AssignmentExpression(lexer);
...
soulng::parser::Match ParserExpressionParser::ConstantExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        int64_t pos = lexer.GetPos();
        soulng::parser::Match match = ParserExpressionParser::CppExpression(lexer);
...
soulng::parser::Match ParserExpressionParser::AssignmentExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    soulng::parser::Match match = ParserExpressionParser::LogicalOrExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    *parentMatch3 = match;
                }
                if (match.hit)
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        soulng::parser::Match match = ParserExpressionParser::AssignmentOp(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = ParserExpressionParser::ConditionalExpression(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::ThrowExpression(lexer);
...
soulng::parser::Match ParserExpressionParser::AssignmentOp(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::ConditionalExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::ThrowExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::LogicalOrExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::LogicalAndExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
...
soulng::parser::Match ParserExpressionParser::LogicalAndExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::InclusiveOrExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
...
soulng::parser::Match ParserExpressionParser::InclusiveOrExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::ExclusiveOrExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
...
soulng::parser::Match ParserExpressionParser::ExclusiveOrExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::AndExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
...
soulng::parser::Match ParserExpressionParser::AndExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::EqualityExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
...
soulng::parser::Match ParserExpressionParser::EqualityExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::RelationalExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = ParserExpressionParser::EqOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match ParserExpressionParser::EqOp(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::RelationalExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::ShiftExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = ParserExpressionParser::RelOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match ParserExpressionParser::RelOp(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::ShiftExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::AdditiveExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = ParserExpressionParser::ShiftOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match ParserExpressionParser::ShiftOp(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::AdditiveExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::MultiplicativeExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = ParserExpressionParser::AddOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match ParserExpressionParser::AddOp(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::MultiplicativeExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::PmExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = ParserExpressionParser::MulOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match ParserExpressionParser::MulOp(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::PmExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserExpressionParser::CastExpression(lexer);
                    left.reset(static_cast<soulng::cppcode::CppObject*>(match.value));
                    if (match.hit)
                    {
                        expr.reset(left.release());
                        ...
                        while (true)
                        {
                            int64_t save = lexer.GetPos();
                            {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        soulng::parser::Match match = ParserExpressionParser::PmOp(lexer);
                                        op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                        *parentMatch7 = match;
                                    }
                                    if (match.hit)
...
soulng::parser::Match ParserExpressionParser::PmOp(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::CastExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = ParserExpressionParser::UnaryExpression(lexer);
...
soulng::parser::Match ParserExpressionParser::UnaryExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                                ...
                                soulng::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch8 = &match;
                                    {
                                        ...
                                        soulng::parser::Match* parentMatch9 = &match;
                                        {
                                            ...
                                            {
                                                int64_t pos = lexer.GetPos();
                                                soulng::parser::Match match = ParserExpressionParser::PostfixExpression(lexer);
                                            ...
                                            *parentMatch9 = match;
                                            if (!match.hit)
                                            {
                                                ...
                                                lexer.SetPos(save);
                                                {
                                                    ...
                                                    {
                                                        int64_t pos = lexer.GetPos();
                                                        soulng::parser::Match match = ParserExpressionParser::PostCastExpression(lexer);
                                ...
                                *parentMatch6 = match;
                                if (!match.hit)
                                {
                                    ...
                                    lexer.SetPos(save);
                                    {
                                        ...
                                        {
                                            soulng::parser::Match match = ParserExpressionParser::UnaryOperator(lexer);
                                            op.reset(static_cast<soulng::parser::Value<soulng::cppcode::Operator>*>(match.value));
                                            *parentMatch24 = match;
                                        }
                                        if (match.hit)
                    ...
                    *parentMatch3 = match;
                    if (!match.hit)
                    {
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::parser::Match match = ParserExpressionParser::NewExpression(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = ParserExpressionParser::DeleteExpression(lexer);
...
soulng::parser::Match ParserExpressionParser::UnaryOperator(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::PostfixExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = ParserExpressionParser::PrimaryExpression(lexer);
                                                                    ...
                                                                    soulng::parser::Match* parentMatch20 = &match;
                                                                    {
                                                                        ...
                                                                        if (match.hit)
                                                                        {
                                                                            ...
                                                                            soulng::parser::Match* parentMatch23 = &match;
                                                                            {
                                                                                ...
                                                                                soulng::parser::Match* parentMatch24 = &match;
                                                                                {
                                                                                    soulng::parser::Match match = ParserExpressionParser::ExpressionList(lexer, expr.get());
                                                                                    if (match.hit)
                                                                                    {
                                                                                        *parentMatch24 = match;
                                                                                    }
                                                                ...
                                                                if (match.hit)
                                                                {
                                                                    ...
                                                                    soulng::parser::Match* parentMatch29 = &match;
                                                                    {
                                                                        ...
                                                                        soulng::parser::Match* parentMatch30 = &match;
                                                                        {
                                                                            ...
                                                                            {
                                                                                soulng::lexer::Span span = lexer.GetSpan();
                                                                                soulng::parser::Match match = ParserExpressionParser::IdExpression(lexer);
                        ...
                        soulng::parser::Match* parentMatch42 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch43 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch44 = &match;
                                {
                                    ...
                                    {
                                        int64_t pos = lexer.GetPos();
                                        soulng::parser::Match match = ParserExpressionParser::TypeSpecifierOrTypeName(lexer);
...
soulng::parser::Match ParserExpressionParser::PostCastExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::ExpressionList(ParserFileLexer& lexer, soulng::cppcode::CppObject* owner)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::PrimaryExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserLiteralParser::CppLiteral(lexer);
...
soulng::parser::Match ParserExpressionParser::IdExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                    ...
                    if (match.hit)
                    {
                        ...
                        soulng::parser::Match* parentMatch8 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch9 = &match;
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::lexer::Span span = lexer.GetSpan();
                                soulng::parser::Match match = ParserExpressionParser::OperatorFunctionId(lexer);
...
soulng::parser::Match ParserExpressionParser::TypeSpecifierOrTypeName(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            int64_t pos = lexer.GetPos();
            soulng::parser::Match match = ParserDeclarationParser::SimpleTypeSpecifier(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = ParserDeclarationParser::TypeName(lexer);
...
soulng::parser::Match ParserExpressionParser::NewExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soulng::parser::Match* parentMatch17 = &match;
                                    {
                                        ...
                                        soulng::parser::Match* parentMatch18 = &match;
                                        {
                                            soulng::parser::Match match = ParserExpressionParser::NewPlacement(lexer, newExpr.get());
                                            if (match.hit)
                                            {
                                                *parentMatch18 = match;
                                            }
                            ...
                            soulng::parser::Match* parentMatch21 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch22 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch23 = &match;
                                    {
                                        ...
                                        {
                                            int64_t pos = lexer.GetPos();
                                            soulng::parser::Match match = ParserExpressionParser::NewTypeId(lexer);
                ...
                if (match.hit)
                {
                    ...
                    soulng::parser::Match* parentMatch33 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch34 = &match;
                        {
                            soulng::parser::Match match = ParserExpressionParser::NewInitializer(lexer, newExpr.get());
                            if (match.hit)
                            {
                                *parentMatch34 = match;
                            }
...
soulng::parser::Match ParserExpressionParser::NewPlacement(ParserFileLexer& lexer, soulng::cppcode::CppObject* owner)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                soulng::parser::Match match = ParserExpressionParser::ExpressionList(lexer, owner);
                *parentMatch2 = match;
            }
            *parentMatch1 = match;
        }
...
soulng::parser::Match ParserExpressionParser::NewTypeId(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                soulng::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            {
                                int64_t save = lexer.GetPos();
                                soulng::parser::Match match = ParserDeclaratorParser::TypeSpecifierSeq(lexer, ti.get());
                                *parentMatch7 = match;
                                if (!match.hit)
                                {
                                    soulng::parser::Match match(false);
                        ...
                        soulng::parser::Match* parentMatch10 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch11 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch12 = &match;
                                {
                                    ...
                                    {
                                        int64_t pos = lexer.GetPos();
                                        soulng::parser::Match match = ParserExpressionParser::NewDeclarator(lexer);
...
soulng::parser::Match ParserExpressionParser::NewDeclarator(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch7 = &match;
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::lexer::Span span = lexer.GetSpan();
                                soulng::parser::Match match = ParserDeclaratorParser::PtrOperator(lexer);
                                if (match.hit)
                                {
                                    s.end = span.end;
                                }
                        ...
                        if (!match.hit)
                        {
                            ...
                            lexer.SetPos(save);
                            {
                                ...
                                soulng::parser::Match* parentMatch13 = &match;
                                {
                                    int64_t pos = lexer.GetPos();
                                    soulng::lexer::Span span = lexer.GetSpan();
                                    soulng::parser::Match match = ParserExpressionParser::DirectNewDeclarator(lexer);
                                    if (match.hit)
                                    {
                                        s.end = span.end;
                                    }
...
soulng::parser::Match ParserExpressionParser::NewInitializer(ParserFileLexer& lexer, soulng::cppcode::CppObject* owner)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::DirectNewDeclarator(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                        ...
                        soulng::parser::Match* parentMatch7 = &match;
                        {
                            ...
                            soulng::parser::Match* parentMatch8 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soulng::parser::Match* parentMatch10 = &match;
                                    {
                                        soulng::parser::Match match = ParserExpressionParser::ConstantExpression(lexer);
...
soulng::parser::Match ParserExpressionParser::DeleteExpression(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match ParserExpressionParser::OperatorFunctionId(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    if (match.hit)
    {
        ...
        soulng::parser::Match* parentMatch2 = &match;
        {
            ...
            soulng::parser::Match* parentMatch3 = &match;
            {
                int64_t pos = lexer.GetPos();
                soulng::lexer::Span span = lexer.GetSpan();
                soulng::parser::Match match = ParserExpressionParser::Operator(lexer);
                if (match.hit)
                {
                    s.end = span.end;
                    {
...
soulng::parser::Match ParserExpressionParser::Operator(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
