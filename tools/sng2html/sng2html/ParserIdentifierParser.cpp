#include "ParserIdentifierParser.hpp"
...
soulng::parser::Match ParserIdentifierParser::CppIdentifier(ParserFileLexer& lexer)
{
...
soulng::parser::Match ParserIdentifierParser::QualifiedCppId(ParserFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
