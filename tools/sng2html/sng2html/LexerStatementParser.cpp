...
soulng::parser::Match LexerStatementParser::Statement(LexerFileLexer& lexer)
{
                            ...
                            soulng::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch8 = &match;
                                    {
                                        ...
                                        soulng::parser::Match match = LexerStatementParser::LabeledStatement(lexer);
                                    ...
                                    *parentMatch7 = match;
                                    if (!match.hit)
                                    {
                                        ...
                                        lexer.SetPos(save);
                                        {
                                            ...
                                            {
                                                int64_t pos = lexer.GetPos();
                                                soulng::parser::Match match = LexerStatementParser::EmptyStatement(lexer);
                                ...
                                *parentMatch6 = match;
                                if (!match.hit)
                                {
                                    ...
                                    lexer.SetPos(save);
                                    {
                                        ...
                                        {
                                            int64_t pos = lexer.GetPos();
                                            soulng::parser::Match match = LexerStatementParser::CompoundStatement(lexer);
                            ...
                            *parentMatch5 = match;
                            if (!match.hit)
                            {
                                ...
                                lexer.SetPos(save);
                                {
                                    ...
                                    {
                                        int64_t pos = lexer.GetPos();
                                        soulng::parser::Match match = LexerStatementParser::SelectionStatement(lexer);
                        ...
                        *parentMatch4 = match;
                        if (!match.hit)
                        {
                            ...
                            lexer.SetPos(save);
                            {
                                ...
                                {
                                    int64_t pos = lexer.GetPos();
                                    soulng::parser::Match match = LexerStatementParser::IterationStatement(lexer);
                    ...
                    *parentMatch3 = match;
                    if (!match.hit)
                    {
                        ...
                        lexer.SetPos(save);
                        {
                            ...
                            {
                                int64_t pos = lexer.GetPos();
                                soulng::parser::Match match = LexerStatementParser::JumpStatement(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = LexerStatementParser::DeclarationStatement(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = LexerStatementParser::TryStatement(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerStatementParser::ExpressionStatement(lexer);
...
soulng::parser::Match LexerStatementParser::LabeledStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch6 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch7 = &match;
                    {
                        ...
                        {
                            soulng::lexer::Span span = lexer.GetSpan();
                            soulng::parser::Match match = LexerStatementParser::Statement(lexer);
...
soulng::parser::Match LexerStatementParser::EmptyStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerStatementParser::CompoundStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerStatementParser::SelectionStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        {
            int64_t pos = lexer.GetPos();
            soulng::parser::Match match = LexerStatementParser::IfStatement(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerStatementParser::SwitchStatement(lexer);
...
soulng::parser::Match LexerStatementParser::IfStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            soulng::parser::Match* parentMatch9 = &match;
                            {
                                ...
                                {
                                    soulng::lexer::Span span = lexer.GetSpan();
                                    soulng::parser::Match match = LexerStatementParser::Condition(lexer);
...
soulng::parser::Match LexerStatementParser::SwitchStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerStatementParser::IterationStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerStatementParser::WhileStatement(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = LexerStatementParser::DoStatement(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = LexerStatementParser::RangeForStatement(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerStatementParser::ForStatement(lexer);
...
soulng::parser::Match LexerStatementParser::WhileStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerStatementParser::DoStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerStatementParser::RangeForStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        ...
                        soulng::parser::Match* parentMatch7 = &match;
                        {
                            soulng::parser::Match match = LexerStatementParser::ForRangeDeclaration(lexer);
...
soulng::parser::Match LexerStatementParser::ForRangeDeclaration(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        soulng::parser::Match match = LexerDeclaratorParser::TypeSpecifierSeq(lexer, forRangeDeclaration->GetTypeId());
                        *parentMatch5 = match;
                    }
                    *parentMatch3 = match;
                }
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch6 = &match;
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = LexerDeclaratorParser::Declarator(lexer);
...
soulng::parser::Match LexerStatementParser::ForStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            ...
                            soulng::parser::Match* parentMatch8 = &match;
                            {
                                soulng::parser::Match match = LexerStatementParser::ForInitStatement(lexer);
...
soulng::parser::Match LexerStatementParser::ForInitStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerDeclarationParser::SimpleDeclaration(lexer);
...
soulng::parser::Match LexerStatementParser::JumpStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerStatementParser::BreakStatement(lexer);
                ...
                *parentMatch2 = match;
                if (!match.hit)
                {
                    ...
                    lexer.SetPos(save);
                    {
                        ...
                        {
                            int64_t pos = lexer.GetPos();
                            soulng::parser::Match match = LexerStatementParser::ContinueStatement(lexer);
            ...
            *parentMatch1 = match;
            if (!match.hit)
            {
                ...
                lexer.SetPos(save);
                {
                    ...
                    {
                        int64_t pos = lexer.GetPos();
                        soulng::parser::Match match = LexerStatementParser::ReturnStatement(lexer);
        ...
        *parentMatch0 = match;
        if (!match.hit)
        {
            ...
            lexer.SetPos(save);
            {
                ...
                {
                    int64_t pos = lexer.GetPos();
                    soulng::parser::Match match = LexerStatementParser::GotoStatement(lexer);
...
soulng::parser::Match LexerStatementParser::BreakStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerStatementParser::ContinueStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerStatementParser::ReturnStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerStatementParser::GotoStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerStatementParser::DeclarationStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        int64_t pos = lexer.GetPos();
        soulng::parser::Match match = LexerDeclarationParser::BlockDeclaration(lexer);
...
soulng::parser::Match LexerStatementParser::Condition(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerStatementParser::TryStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match LexerStatementParser::HandlerSeq(LexerFileLexer& lexer, soulng::cppcode::TryStatement* tryStatement)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            {
                soulng::lexer::Span span = lexer.GetSpan();
                soulng::parser::Match match = LexerStatementParser::Handler(lexer);
    ...
    if (match.hit)
    {
        ...
        soulng::parser::Match* parentMatch3 = &match;
        {
            ...
            soulng::parser::Match* parentMatch4 = &match;
            {
                soulng::parser::Match match = LexerStatementParser::HandlerSeq(lexer, tryStatement);
                if (match.hit)
                {
                    *parentMatch4 = match;
                }
...
soulng::parser::Match LexerStatementParser::Handler(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            if (match.hit)
            {
                ...
                soulng::parser::Match* parentMatch6 = &match;
                {
                    ...
                    {
                        soulng::lexer::Span span = lexer.GetSpan();
                        soulng::parser::Match match = LexerStatementParser::ExceptionDeclaration(lexer);
...
soulng::parser::Match LexerStatementParser::ExceptionDeclaration(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soulng::parser::Match* parentMatch3 = &match;
            {
                ...
                soulng::parser::Match* parentMatch4 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch6 = &match;
                        {
                            soulng::parser::Match match = LexerDeclaratorParser::TypeSpecifierSeq(lexer, exceptionDeclaration->GetTypeId());
                            *parentMatch6 = match;
                        }
                        if (match.hit)
                        {
                                            ...
                                            *parentMatch10 = match;
                                            if (!match.hit)
                                            {
                                                ...
                                                lexer.SetPos(save);
                                                {
                                                    ...
                                                    {
                                                        int64_t pos = lexer.GetPos();
                                                        soulng::parser::Match match = LexerDeclaratorParser::AbstractDeclarator(lexer);
...
soulng::parser::Match LexerStatementParser::ExpressionStatement(LexerFileLexer& lexer)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
