...
// this file has been automatically generated from 'D:/work/soulng-project/tools/gendoc/html/ParserFileTokenLexer.lexer' using soulng lexer generator slg version 1.2.0
...
namespace ParserFileTokenLexerTokens
{
    ...
    void InitTokenIdMap()
    {
        ...
        tokenIdMap[U"COLONCOLON"] = 100;
        tokenIdMap[U"COMMA"] = 104;
        ...
        tokenIdMap[U"KEYWORD"] = 119;
        tokenIdMap[U"LANGLE"] = 97;
        tokenIdMap[U"LBRACE"] = 93;
        tokenIdMap[U"LBRACKET"] = 95;
        tokenIdMap[U"LEQ"] = 76;
        tokenIdMap[U"LINECOMMENT"] = 117;
        tokenIdMap[U"LONG"] = 24;
        tokenIdMap[U"LPAREN"] = 91;
        tokenIdMap[U"MAIN"] = 4;
        tokenIdMap[U"MINUS"] = 81;
        tokenIdMap[U"MINUSASSIGN"] = 110;
        tokenIdMap[U"MINUSMINUS"] = 86;
        tokenIdMap[U"MULASSIGN"] = 106;
        tokenIdMap[U"MUTABLE"] = 18;
        tokenIdMap[U"NAMESPACE"] = 34;
        tokenIdMap[U"NEQ"] = 75;
        tokenIdMap[U"NEW"] = 44;
        tokenIdMap[U"NULLPTR"] = 48;
        tokenIdMap[U"NUMBER"] = 121;
        tokenIdMap[U"OPERATOR"] = 37;
        tokenIdMap[U"ORASSIGN"] = 115;
        tokenIdMap[U"OTHER"] = 123;
        tokenIdMap[U"PARSER"] = 1;
        tokenIdMap[U"PLUS"] = 80;
        tokenIdMap[U"PLUSASSIGN"] = 109;
        tokenIdMap[U"PLUSPLUS"] = 85;
        tokenIdMap[U"PP"] = 122;
        tokenIdMap[U"PRODUCES"] = 12;
        tokenIdMap[U"QUEST"] = 90;
        tokenIdMap[U"RANGLE"] = 98;
        tokenIdMap[U"RBRACE"] = 94;
        tokenIdMap[U"RBRACKET"] = 96;
        tokenIdMap[U"REGISTER"] = 15;
        tokenIdMap[U"REINTERPRETCAST"] = 40;
        tokenIdMap[U"REM"] = 84;
        tokenIdMap[U"REMASSIGN"] = 108;
        tokenIdMap[U"RETURN"] = 59;
        tokenIdMap[U"RPAREN"] = 92;
        tokenIdMap[U"RULEINFO"] = 6;
        tokenIdMap[U"SEMICOLON"] = 102;
        tokenIdMap[U"SHIFTLEFT"] = 78;
        tokenIdMap[U"SHIFTLEFTASSIGN"] = 111;
        tokenIdMap[U"SHIFTRIGHT"] = 79;
        tokenIdMap[U"SHIFTRIGHTASSIGN"] = 112;
