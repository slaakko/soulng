...
HtmlParserFileSourceGenerator::HtmlParserFileSourceGenerator(const std::u32string& projectName_, const std::vector<std::u32string>& inputLines_, int numDigits_, const std::string& styleDirName_,
...
void HtmlParserFileSourceGenerator::Visit(SourceFileNode& sourceFileNode)
{
    ...
    {
        OpenLine();
        ParseParserFileSourceLine(line, writer);
        CloseLine();
    }
...
void HtmlParserFileSourceGenerator::OpenLine()
{
...
void HtmlParserFileSourceGenerator::CloseLine()
{
