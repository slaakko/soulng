...
#include <soulng/syntax/ProjectFile.hpp>
#include <soulng/syntax/LibraryFile.hpp>
#include <soulng/syntax/ParserFile.hpp>
#include <soulng/syntax/Library.hpp>
#include <soulng/syntax/CodeGenerator.hpp>
#include <soulng/util/TextUtils.hpp>
#include <soulng/util/MappedInputFile.hpp>
#include <soulng/util/Unicode.hpp>
#include <soulng/parsing/Linking.hpp>
...
void Generate(const std::string& projectFilePath, const std::vector<std::string>& libraryDirectories)
{
    ...
    std::unique_ptr<soulng::parsing::ParsingDomain> projectParsingDomain(new soulng::parsing::ParsingDomain());
    ...
    std::unique_ptr<soulng::parsing::ParsingDomain> parsingDomain(new soulng::parsing::ParsingDomain());
    ...
    soulng::parsing::SetFileInfo(sourceFiles);
    ...
    std::cout << "Linking...\n";
    soulng::parsing::Link(parsingDomain.get());
    std::cout << "Expanding code...\n";
    soulng::parsing::ExpandCode(parsingDomain.get());
