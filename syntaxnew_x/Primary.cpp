...
public:
    ...
    void PostExpressionList(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromExpressionList = *static_cast<soulng::parsing::ValueObject<std::vector<soulng::cppcode::CppObject*>>*>(fromExpressionList_value.get());
            stack.pop();
        }
    }
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        std::vector<soulng::cppcode::CppObject*> fromExpressionList;
...
public:
    ...
    void Postaction(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        {
            std::unique_ptr<soulng::parsing::Object> fromaction_value = std::move(stack.top());
            context->fromaction = *static_cast<soulng::parsing::ValueObject<soulng::cppcode::CompoundStatement*>*>(fromaction_value.get());
            stack.pop();
        }
    }
    void PostfailureAction(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromfailureAction = *static_cast<soulng::parsing::ValueObject<soulng::cppcode::CompoundStatement*>*>(fromfailureAction_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::parsing::Parser* child;
        soulng::parsing::Parser* value;
        soulng::cppcode::CompoundStatement* fromaction;
        soulng::cppcode::CompoundStatement* fromfailureAction;
    };
};
