...
UTIL_API bool StartsWith(const std::u32string& s, const std::u32string& prefix);
UTIL_API bool EndsWith(const std::string& s, const std::string& suffix);
UTIL_API bool EndsWith(const std::u32string& s, const std::u32string& suffix);
...
UTIL_API std::string Utf8StringToPlatformString(const std::string& utf8String);
