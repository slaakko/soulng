...
#ifndef SOULNG_CPPCODE_VISITOR_INCLUDED
#define SOULNG_CPPCODE_VISITOR_INCLUDED
...
public:
    ...
    virtual void Visit(ParenExpr& object) {}
    ...
    virtual void Visit(ForRangeDeclaration& object) {}
    virtual void Visit(RangeForStatement& object) {}
...
#endif // SOULNG_CPPCODE_VISITOR_INCLUDED
