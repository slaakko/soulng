...
// this file has been automatically generated from 'C:/work/soulng/soulng/spg/ProjectFileParser.parser' using soulng parser generator spg version 3.1.0
                ...
                soulng::parser::Match* parentMatch1 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch2 = &match;
                    {
                        ...
                        soulng::parser::Match* parentMatch3 = &match;
                        {
                            ...
                            {
                                int64_t save = lexer.GetPos();
                                soulng::parser::Match match = ProjectFileParser::RecoveryDeclaration(lexer, projectFile);
                                *parentMatch4 = match;
                                if (!match.hit)
                                {
                                    soulng::parser::Match match(false);
                                    ...
                                    lexer.SetPos(save);
                                    {
                                        soulng::parser::Match match = ProjectFileParser::TokensDeclaration(lexer, projectFile);
                                        *parentMatch5 = match;
                                    }
                                    *parentMatch4 = match;
                                }
                            ...
                            *parentMatch3 = match;
                            if (!match.hit)
                            {
                                ...
                                lexer.SetPos(save);
                                {
                                    soulng::parser::Match match = ProjectFileParser::RuleFileDeclaration(lexer, projectFile);
                                    *parentMatch6 = match;
                                }
                                *parentMatch3 = match;
                            }
...
soulng::parser::Match ProjectFileParser::TokensDeclaration(ProjectFileLexer& lexer, soulng::spg::ProjectFile* projectFile)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        parser_debug_match_span = lexer.GetSpan();
        soulng::lexer::WriteBeginRuleToLog(lexer, soulng::unicode::ToUtf32("TokensDeclaration"));
    }
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
        ...
        if (match.hit)
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match* parentMatch3 = &match;
                {
                    ...
                    if (match.hit)
                    {
                        projectFile->AddTokenFile(lexer.filePath);
                    }
                    *parentMatch3 = match;
                }
                *parentMatch2 = match;
    ...
    if (parser_debug_write_to_log)
    {
        if (match.hit) soulng::lexer::WriteSuccessToLog(lexer, parser_debug_match_span, soulng::unicode::ToUtf32("TokensDeclaration"));
        else soulng::lexer::WriteFailureToLog(lexer, soulng::unicode::ToUtf32("TokensDeclaration"));
    }
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    if (!match.hit)
    {
...
soulng::parser::Match ProjectFileParser::RuleFileDeclaration(ProjectFileLexer& lexer, soulng::spg::ProjectFile* projectFile)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        parser_debug_match_span = lexer.GetSpan();
        soulng::lexer::WriteBeginRuleToLog(lexer, soulng::unicode::ToUtf32("RuleFileDeclaration"));
    }
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    ...
    if (parser_debug_write_to_log)
    {
        if (match.hit) soulng::lexer::WriteSuccessToLog(lexer, parser_debug_match_span, soulng::unicode::ToUtf32("RuleFileDeclaration"));
        else soulng::lexer::WriteFailureToLog(lexer, soulng::unicode::ToUtf32("RuleFileDeclaration"));
    }
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    if (!match.hit)
    {
...
soulng::parser::Match ProjectFileParser::RecoveryDeclaration(ProjectFileLexer& lexer, soulng::spg::ProjectFile* projectFile)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        parser_debug_match_span = lexer.GetSpan();
        soulng::lexer::WriteBeginRuleToLog(lexer, soulng::unicode::ToUtf32("RecoveryDeclaration"));
    }
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    ...
    if (parser_debug_write_to_log)
    {
        if (match.hit) soulng::lexer::WriteSuccessToLog(lexer, parser_debug_match_span, soulng::unicode::ToUtf32("RecoveryDeclaration"));
        else soulng::lexer::WriteFailureToLog(lexer, soulng::unicode::ToUtf32("RecoveryDeclaration"));
    }
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    if (!match.hit)
    {
