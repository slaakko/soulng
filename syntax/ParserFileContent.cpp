...
ParserFileContent::ParserFileContent(int id_, soulng::parsing::ParsingDomain* parsingDomain_): id(id_), parsingDomain(parsingDomain_)
{
}
...
void ParserFileContent::AddUsingObject(soulng::codedom::UsingObject* usingObjectSubject)
{
    soulng::parsing::Scope* enclosingScope = parsingDomain->CurrentScope();
...
void ParserFileContent::AddGrammar(soulng::parsing::Grammar* grammar)
{
    grammar->SetOwner(id);
