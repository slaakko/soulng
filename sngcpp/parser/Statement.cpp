...
// this file has been automatically generated from 'D:/work/soulng-project/sngcpp/parser/Statement.parser' using soulng parser generator spg version 1.2.0
                            ...
                            if (match.hit)
                            {
                                ...
                                soulng::parser::Match* parentMatch49 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch50 = &match;
                                    {
                                        ...
                                        {
                                            lexer.ThrowExpectationFailure(pos, U"ForRangeInitializer");
                                        }
                                    }
                                    *parentMatch49 = match;
                                }
        ...
        soulng::parser::Match* parentMatch6 = &match;
        {
            ...
            soulng::parser::Match* parentMatch7 = &match;
            {
                ...
                soulng::parser::Match* parentMatch8 = &match;
                {
                    ...
                    {
                        lexer.ThrowExpectationFailure(pos, U"HandlerSequence");
                    }
                }
                if (match.hit)
                {
