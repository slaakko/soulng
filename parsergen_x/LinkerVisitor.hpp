...
#ifndef SOULNG_PARSERGEN_LINKER_VISITOR_INCLUDED
#define SOULNG_PARSERGEN_LINKER_VISITOR_INCLUDED
...
{
public:
    enum class Stage { addGrammars, resolveRules };
    LinkerVisitor();
...
#endif // SOULNG_PARSERGEN_LINKER_VISITOR_INCLUDED
