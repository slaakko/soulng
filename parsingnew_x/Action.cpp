...
ActionParser::ActionParser(const std::u32string& name_, soulng::cppcode::CompoundStatement* successCode_, Parser* child_): 
    UnaryParser(name_, child_, child_->Info()), successCode(successCode_), failCode(), action(), failureAction() 
{
}

ActionParser::ActionParser(const std::u32string& name_, soulng::cppcode::CompoundStatement* successCode_, soulng::cppcode::CompoundStatement* failCode_, 
