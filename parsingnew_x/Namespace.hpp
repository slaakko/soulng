...
{
public:
    UsingObject(soulng::cppcode::UsingObject* subject_, Scope* enclosingScope_);
    void Accept(Visitor& visitor) override;
    soulng::cppcode::UsingObject* Subject() const { return subject; }
private:
    soulng::cppcode::UsingObject* subject;
    std::unique_ptr<soulng::cppcode::UsingObject> ownedSubject;
};
