...
void ParserFileGrammar::GetReferencedGrammars()
{
    ...
    soulng::parsing::Grammar* grammar1 = pd->GetGrammar(ToUtf32("soulng.code.Statement"));
    if (!grammar1)
    {
        grammar1 = soulng::code::Statement::Create(pd);
    }
    ...
    soulng::parsing::Grammar* grammar4 = pd->GetGrammar(ToUtf32("soulng.code.Identifier"));
    if (!grammar4)
    {
        grammar4 = soulng::code::Identifier::Create(pd);
    }
    ...
    AddRule(new LexerStatementRule(ToUtf32("LexerStatement"), GetScope(), GetParsingDomain()->GetNextRuleId(),
        new soulng::parsing::ActionParser(ToUtf32("A0"),
            new soulng::parsing::GroupingParser(
                new soulng::parsing::SequenceParser(
                    new soulng::parsing::SequenceParser(
                        new soulng::parsing::KeywordParser(ToUtf32("uselexer")),
