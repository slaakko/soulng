...
#ifndef SNGCM_AST_SOURCE_WRITER_INCLUDED
#define SNGCM_AST_SOURCE_WRITER_INCLUDED
...
class SNGCM_AST_API SourceWriter : public Visitor
{
public:
...
#endif // SNGCM_AST_SOURCE_WRITER_INCLUDED
