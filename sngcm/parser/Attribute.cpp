...
// this file has been automatically generated from 'D:/work/soulng-project/sngcm/parser/Attribute.parser' using soulng parser generator spg version 3.0.0
...
soulng::parser::Match AttributeParser::Attributes(CmajorLexer& lexer)
{
        ...
        soulng::parser::Match* parentMatch11 = &match;
        {
            ...
            soulng::parser::Match* parentMatch12 = &match;
            {
                ...
                if (match.hit)
                {
                    {
                        #ifdef SOULNG_PARSER_DEBUG_SUPPORT
                        if (parser_debug_write_to_log) soulng::lexer::WriteSuccessToLog(lexer, parser_debug_match_span, soulng::unicode::ToUtf32("Attributes"));
                        #endif // SOULNG_PARSER_DEBUG_SUPPORT
    ...
    if (parser_debug_write_to_log)
    {
        if (match.hit) soulng::lexer::WriteSuccessToLog(lexer, parser_debug_match_span, soulng::unicode::ToUtf32("Attributes"));
        else soulng::lexer::WriteFailureToLog(lexer, soulng::unicode::ToUtf32("Attributes"));
    }
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    return match;
}
