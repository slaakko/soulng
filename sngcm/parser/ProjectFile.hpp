...
{
    static std::unique_ptr<sngcm::ast::Project> Parse(ContainerFileLexer& lexer, std::string config, sngcm::ast::BackEnd backend);
    static soulng::parser::Match ProjectFile(ContainerFileLexer& lexer, std::string config, sngcm::ast::BackEnd backend);
