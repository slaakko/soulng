...
#ifndef SOULNG_LEXERGEN_CONTEXT_INCLUDED
#define SOULNG_LEXERGEN_CONTEXT_INCLUDED
...
{
public:
    LexerContext(bool useAsciiIdentifierClasses);
    ~LexerContext();
...
#endif // SOULNG_LEXERGEN_CONTEXT_INCLUDED
