...
soulng::codedom::CppObject* Declaration::Parse(const char32_t* start, const char32_t* end, int fileIndex, const std::string& fileName)
{
...
public:
    ...
    void PostNamespaceAliasDefinition(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromNamespaceAliasDefinition = *static_cast<soulng::parsing::ValueObject<soulng::codedom::UsingObject*>*>(fromNamespaceAliasDefinition_value.get());
            stack.pop();
        }
    }
    void PostUsingDirective(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromUsingDirective = *static_cast<soulng::parsing::ValueObject<soulng::codedom::UsingObject*>*>(fromUsingDirective_value.get());
            stack.pop();
        }
    }
    void PostUsingDeclaration(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromUsingDeclaration = *static_cast<soulng::parsing::ValueObject<soulng::codedom::UsingObject*>*>(fromUsingDeclaration_value.get());
            stack.pop();
        }
    }
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::UsingObject* fromNamespaceAliasDefinition;
        soulng::codedom::UsingObject* fromUsingDirective;
        soulng::codedom::UsingObject* fromUsingDeclaration;
...
public:
    SimpleDeclarationRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::SimpleDeclaration*"));
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::SimpleDeclaration*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    ...
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
        stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::SimpleDeclaration*>(context->sd.get())));
    }
    void PostInitDeclaratorList(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromInitDeclaratorList = *static_cast<soulng::parsing::ValueObject<soulng::codedom::InitDeclaratorList*>*>(fromInitDeclaratorList_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::SimpleDeclaration* value;
        std::unique_ptr<SimpleDeclaration> sd;
        soulng::codedom::InitDeclaratorList* fromInitDeclaratorList;
    };
};
...
public:
    DeclSpecifierSeqRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        AddInheritedAttribute(AttrOrVariable(ToUtf32("soulng::codedom::SimpleDeclaration*"), ToUtf32("declaration")));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
        ...
        context->declaration = *static_cast<soulng::parsing::ValueObject<soulng::codedom::SimpleDeclaration*>*>(declaration_value.get());
        stack.pop();
    }
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
    ...
    void PostDeclSpecifier(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromDeclSpecifier = *static_cast<soulng::parsing::ValueObject<soulng::codedom::DeclSpecifier*>*>(fromDeclSpecifier_value.get());
            stack.pop();
        }
    }
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::SimpleDeclaration* declaration;
        soulng::codedom::DeclSpecifier* fromDeclSpecifier;
...
public:
    DeclSpecifierRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::DeclSpecifier*"));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::DeclSpecifier*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    ...
    void PostStorageClassSpecifier(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromStorageClassSpecifier = *static_cast<soulng::parsing::ValueObject<soulng::codedom::StorageClassSpecifier*>*>(fromStorageClassSpecifier_value.get());
            stack.pop();
        }
    }
    void PostTypeSpecifier(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromTypeSpecifier = *static_cast<soulng::parsing::ValueObject<soulng::codedom::TypeSpecifier*>*>(fromTypeSpecifier_value.get());
            stack.pop();
        }
    }
    void PostTypedef(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromTypedef = *static_cast<soulng::parsing::ValueObject<soulng::codedom::DeclSpecifier*>*>(fromTypedef_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::DeclSpecifier* value;
        soulng::codedom::StorageClassSpecifier* fromStorageClassSpecifier;
        soulng::codedom::TypeSpecifier* fromTypeSpecifier;
        soulng::codedom::DeclSpecifier* fromTypedef;
    };
};
...
public:
    StorageClassSpecifierRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::StorageClassSpecifier*"));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::StorageClassSpecifier*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
...
private:
    ...
    {
        Context(): value() {}
        soulng::codedom::StorageClassSpecifier* value;
    };
};
...
public:
    TypeSpecifierRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::TypeSpecifier*"));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::TypeSpecifier*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    ...
    void PostCVQualifier(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromCVQualifier = *static_cast<soulng::parsing::ValueObject<soulng::codedom::TypeSpecifier*>*>(fromCVQualifier_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::TypeSpecifier* value;
        soulng::codedom::TypeSpecifier* fromSimpleTypeSpecifier;
        soulng::codedom::TypeSpecifier* fromCVQualifier;
    };
};
...
public:
    TypeNameRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::TypeName*"));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::TypeName*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    ...
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
        context->value = new soulng::codedom::TypeName(std::u32string(matchBegin, matchEnd));
    }
    void A1Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
public:
    TemplateArgumentListRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        AddInheritedAttribute(AttrOrVariable(ToUtf32("soulng::codedom::TypeName*"), ToUtf32("typeName")));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
        ...
        context->typeName = *static_cast<soulng::parsing::ValueObject<soulng::codedom::TypeName*>*>(typeName_value.get());
        stack.pop();
    }
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
    ...
    void PostTemplateArgument(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromTemplateArgument = *static_cast<soulng::parsing::ValueObject<soulng::codedom::CppObject*>*>(fromTemplateArgument_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::TypeName* typeName;
        soulng::codedom::CppObject* fromTemplateArgument;
    };
};
...
public:
    NamespaceAliasDefinitionRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::UsingObject*"));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::UsingObject*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::UsingObject* value;
