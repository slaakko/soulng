...
soulng::codedom::Literal* Literal::Parse(const char32_t* start, const char32_t* end, int fileIndex, const std::string& fileName)
{
    ...
    soulng::codedom::Literal* result = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Literal*>*>(value.get());
    stack.pop();
    return result;
}
...
public:
    ...
    {
        SetValueTypeName(ToUtf32("soulng::codedom::Literal*"));
    }
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::Literal*>(context->value)));
        }
    ...
    void PostIntegerLiteral(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromIntegerLiteral = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Literal*>*>(fromIntegerLiteral_value.get());
            stack.pop();
        }
    }
    void PostCharacterLiteral(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromCharacterLiteral = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Literal*>*>(fromCharacterLiteral_value.get());
            stack.pop();
        }
    }
    void PostFloatingLiteral(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromFloatingLiteral = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Literal*>*>(fromFloatingLiteral_value.get());
            stack.pop();
        }
    }
    void PostStringLiteral(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromStringLiteral = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Literal*>*>(fromStringLiteral_value.get());
            stack.pop();
        }
    }
    void PostBooleanLiteral(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromBooleanLiteral = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Literal*>*>(fromBooleanLiteral_value.get());
            stack.pop();
        }
    }
    void PostPointerLiteral(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromPointerLiteral = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Literal*>*>(fromPointerLiteral_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Literal* value;
        soulng::codedom::Literal* fromIntegerLiteral;
        soulng::codedom::Literal* fromCharacterLiteral;
        soulng::codedom::Literal* fromFloatingLiteral;
        soulng::codedom::Literal* fromStringLiteral;
        soulng::codedom::Literal* fromBooleanLiteral;
        soulng::codedom::Literal* fromPointerLiteral;
    };
};
...
public:
    ...
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
        context->value = new soulng::codedom::Literal(std::u32string(matchBegin, matchEnd));
    }
    void A1Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
public:
    ...
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
        context->value = new soulng::codedom::Literal(U"true");
    }
    void A1Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
        context->value = new soulng::codedom::Literal(U"false");
    }
private:
    struct Context : soulng::parsing::Context
    {
...
public:
    ...
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
        context->value = new soulng::codedom::Literal(U"nullptr");
    }
private:
    struct Context : soulng::parsing::Context
    {
