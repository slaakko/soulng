...
#include <soulng/cmajorparser/BasicType.hpp>
#include <soulng/cmajorparser/Literal.hpp>
#include <soulng/cmajorparser/Template.hpp>
#include <soulng/cmajorparser/Operator.hpp>
