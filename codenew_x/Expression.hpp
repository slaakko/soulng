#ifndef Expression_hpp_15080
#define Expression_hpp_15080
...
public:
    ...
    soulng::cppcode::CppObject* Parse(const char32_t* start, const char32_t* end, int fileIndex, const std::string& fileName);
private:
