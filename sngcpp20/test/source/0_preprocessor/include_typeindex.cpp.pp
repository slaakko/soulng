...
class type_index {  public:
    type_index(const type_info& _Tinfo) noexcept : _Tptr(&_Tinfo) {}
     ...
     bool operator==(const type_index& _Right) const noexcept {
        return *_Tptr == *_Right._Tptr;
    }

     strong_ordering operator<=>(const type_index& _Right) const noexcept {
...
struct hash<type_index> {
    [[deprecated(                                                                                                         "warning STL4007: Many result_type typedefs and all argument_type, first_argument_type, and second_argument_type typedefs are deprecated in C++17. You can define _SILENCE_CXX17_ADAPTOR_TYPEDEFS_DEPRECATION_WARNING or _SILENCE_ALL_CXX17_DEPRECATION_WARNINGS to acknowledge that you have received this warning.")]] typedef type_index _Unnameable_argument;
    [[deprecated(                                                                                                         "warning STL4007: Many result_type typedefs and all argument_type, first_argument_type, and second_argument_type typedefs are deprecated in C++17. You can define _SILENCE_CXX17_ADAPTOR_TYPEDEFS_DEPRECATION_WARNING or _SILENCE_ALL_CXX17_DEPRECATION_WARNINGS to acknowledge that you have received this warning.")]] typedef size_t _Unnameable_result;

     size_t operator()(const type_index& _Keyval) const noexcept {
