...
struct _Non_trivial_copy : _Base {      using _Base::_Base;
...
using _SMF_control_copy = conditional_t<
 ...
 template <class _Base, class... _Types>
struct _Non_trivial_move : _SMF_control_copy<_Base, _Types...> {      using _Mybase = _SMF_control_copy<_Base, _Types...>;
...
using _SMF_control_move = conditional_t<
 ...
 template <class _Base, class... _Types>
struct _Non_trivial_copy_assign : _SMF_control_move<_Base, _Types...> {      using _Mybase = _SMF_control_move<_Base, _Types...>;
    using _Mybase::_Mybase;
...
template <class _Base, class... _Types>
struct _Deleted_copy_assign : _SMF_control_move<_Base, _Types...> {      using _Mybase = _SMF_control_move<_Base, _Types...>;
    using _Mybase::_Mybase;
...
using _SMF_control_copy_assign =
 ...
 template <class _Base, class... _Types>
struct _Non_trivial_move_assign : _SMF_control_copy_assign<_Base, _Types...> {      using _Mybase = _SMF_control_copy_assign<_Base, _Types...>;
    using _Mybase::_Mybase;
...
template <class _Base, class... _Types>
struct _Deleted_move_assign : _SMF_control_copy_assign<_Base, _Types...> {      using _Mybase = _SMF_control_copy_assign<_Base, _Types...>;
    using _Mybase::_Mybase;
...
struct _Optional_destruct_base {      union {
...
template <class _Ty>
struct _Optional_destruct_base<_Ty, false> {      union {
        _Nontrivial_dummy_type _Dummy;
        remove_const_t<_Ty> _Value;
    };
    bool _Has_value;
...
struct _Optional_construct_base : _Optional_destruct_base<_Ty> {
    ...
    template <class _Ty2>
    void _Assign(_Ty2&& _Right) {          if (this->_Has_value) {
    ...
    void _Construct_from(_Self&& _Right) noexcept(
        is_nothrow_constructible_v<_Ty, decltype((::std:: forward<_Self>(_Right)._Value))>) {
    ...
    void _Assign_from(_Self&& _Right) noexcept(
        is_nothrow_constructible_v<_Ty, decltype((::std:: forward<_Self>(_Right)._Value))>&&
            is_nothrow_assignable_v<_Ty&, decltype((::std:: forward<_Self>(_Right)._Value))>) {
                 if (_Right._Has_value) {
...
public:
    ...
    constexpr explicit optional(in_place_t, _Types&&... _Args) : _Mybase(in_place, ::std:: forward<_Types>(_Args)...) {}
    ...
    template <class _Ty2>
     constexpr remove_cv_t<_Ty> value_or(_Ty2&& _Right) const& {
        static_assert(is_convertible_v<const _Ty&, remove_cv_t<_Ty>>,
            "The const overload of optional<T>::value_or requires const T& to be convertible to remove_cv_t<T> (N4885 [optional.observe]/17 as modified by LWG-3424).");
    ...
    template <class _Ty2>
     constexpr remove_cv_t<_Ty> value_or(_Ty2&& _Right) && {
        static_assert(is_convertible_v<_Ty, remove_cv_t<_Ty>>,
            "The rvalue overload of optional<T>::value_or requires T to be convertible to remove_cv_t<T> (N4885 [optional.observe]/19 as modified by LWG-3424).");
        static_assert(is_convertible_v<_Ty2, _Ty>,
...
template <class _Ty1, three_way_comparable_with<_Ty1> _Ty2>
 constexpr compare_three_way_result_t<_Ty1, _Ty2> operator<=>(
...
template <class _Ty>
 constexpr strong_ordering operator<=>(const optional<_Ty>& _Left, nullopt_t) noexcept {
...
template <class _Ty1, class _Ty2, _Enable_if_comparable_with_equal<_Ty1, _Ty2> = 0>
 constexpr bool operator==(const _Ty1& _Left, const optional<_Ty2>& _Right) {
...
template <class _Ty1, class _Ty2, _Enable_if_comparable_with_greater_equal<_Ty1, _Ty2> = 0>
 ...
 template <class _Ty1, class _Ty2>
    requires (!_Is_specialization_v<_Ty2, optional>)          && three_way_comparable_with<_Ty1, _Ty2>
 constexpr compare_three_way_result_t<_Ty1, _Ty2>
