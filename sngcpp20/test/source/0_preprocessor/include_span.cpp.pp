...
struct _Span_iterator {
    ...
    constexpr _Span_iterator& operator+=(const difference_type _Off) noexcept {
     ...
     constexpr _Span_iterator operator+(const difference_type _Off) const noexcept {
        _Span_iterator _Tmp{*this};
        _Tmp += _Off;
        return _Tmp;
    }

     friend constexpr _Span_iterator operator+(const difference_type _Off, _Span_iterator _Next) noexcept {
        return _Next += _Off;
    }
    ...
    constexpr _Span_iterator& operator-=(const difference_type _Off) noexcept {
     ...
     constexpr difference_type operator-(const _Span_iterator& _Right) const noexcept {
     ...
     constexpr bool operator==(const _Span_iterator& _Right) const noexcept {
        return _Myptr == _Right._Myptr;
    }

     constexpr strong_ordering operator<=>(const _Span_iterator& _Right) const noexcept {
        return _Myptr <=> _Right._Myptr;
    }
...
public:
    ...
    constexpr explicit(_Extent != dynamic_extent) span(_It _First, size_type _Count) noexcept          : _Mybase(::std:: to_address(_Get_unwrapped_n(_First, _Count)), _Count) {
    }
    ...
    constexpr explicit(_Extent != dynamic_extent) span(_It _First, _Sentinel _Last)
        noexcept(noexcept(_Last - _First))          : _Mybase(::std:: to_address(_First), static_cast<size_type>(_Last - _First)) {
        _Adl_verify_range(_First, _Last);
    }
    ...
    template <size_t _Offset, size_t _Count = dynamic_extent>
     ...
     constexpr auto subspan(const size_type _Offset, const size_type _Count = dynamic_extent) const noexcept
      {
