...
struct coroutine_handle<void> {
    ...
    coroutine_handle& operator=(nullptr_t) noexcept {
     ...
     static constexpr coroutine_handle from_address(void* const _Addr) noexcept {          coroutine_handle _Result;
        _Result._Ptr = _Addr;
        return _Result;
    }
    ...
    constexpr explicit operator bool() const noexcept {
     ...
     bool done() const noexcept {          return __builtin_coro_done(_Ptr);
    }
    ...
    void destroy() const noexcept {          __builtin_coro_destroy(_Ptr);
    }
...
struct coroutine_handle {
    ...
    constexpr coroutine_handle(nullptr_t) noexcept {}
     ...
     static coroutine_handle from_promise(_Promise& _Prom) noexcept {          const auto _Prom_ptr  = const_cast<void*>(static_cast<const volatile void*>(::std:: addressof(_Prom)));
    ...
    void destroy() const noexcept {          __builtin_coro_destroy(_Ptr);
     ...
     _Promise& promise() const noexcept {          return *reinterpret_cast<_Promise*>(__builtin_coro_promise(_Ptr, 0, false));
    }
...
struct hash<coroutine_handle<_Promise>> {
     size_t operator()(const coroutine_handle<_Promise>& _Coro) const noexcept {
