...
PP_API extern const soulng::lexer::Lexeme ndebug;
...
PP_API std::string ParseAngleHeaderName(const std::string& fileName, const soulng::lexer::Token& headerNameToken);
PP_API std::string ParseQuoteHeaderName(const std::string& fileName, const soulng::lexer::Token& headerNameToken);
PP_API void InitTextTokenCppTokenMap();
PP_API void InitPPTokenTextTokenMap();
PP_API void Preprocess(const std::string& fileName, PP* pp);
