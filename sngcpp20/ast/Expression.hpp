...
public:
    ...
    NewExprNode(const SourcePos& sourcePos_, Node* placement_, Node* child_, Node* initializer_, Node* colonColonHead_);
private:
...
public:
    ...
    ArrayDeletePtrNode(const SourcePos& sourcePos_, Node* ptr_, const SourcePos& lbPos_, const SourcePos& rbPos_);
...
public:
    ...
    DeletePtrNode(const SourcePos& sourcePos_, Node* ptr_);
};
