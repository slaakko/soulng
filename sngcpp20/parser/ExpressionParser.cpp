...
// this file has been automatically generated from 'C:/work/soulng/sngcpp20/parser/ExpressionParser.parser' using soulng parser generator spg version 3.1.0
                            ...
                            soulng::parser::Match* parentMatch7 = &match;
                            {
                                ...
                                soulng::parser::Match* parentMatch8 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch9 = &match;
                                    {
                                        ...
                                        {
                                            lpPos = sourcePos;
                                            invokeNode.reset(new InvokeExprNode(sourcePos, node.release()));
                                        }
                                        *parentMatch9 = match;
                                    }
                                    *parentMatch8 = match;
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soulng::parser::Match* parentMatch10 = &match;
                                    {
                                        soulng::parser::Match match = FunctionParser::ParameterDeclarationClause(lexer, ctx, invokeNode.get());
                                        *parentMatch10 = match;
                                    }
                                    *parentMatch8 = match;
                                }
                            ...
                            *parentMatch5 = match;
                            if (!match.hit)
                            {
                                ...
                                lexer.SetPos(save);
                                {
                                    ...
                                    {
                                        soulng::parser::Match match = GuardParser::ConceptGuard(lexer, ctx);
                                        *parentMatch47 = match;
                                    }
                                    if (match.hit)
                                    {
...
soulng::parser::Match ExpressionParser::FoldExpression(CppLexer& lexer, sngcpp::symbols::Context* ctx)
{
    ...
    std::unique_ptr<Node> op2Node = std::unique_ptr<Node>();
    SourcePos lpPos = SourcePos();
    SourcePos rpPos = SourcePos();
