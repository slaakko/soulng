...
// this file has been automatically generated from 'C:/work/soulng/sngcpp20/parser/GuardParser.parser' using soulng parser generator spg version 3.1.0
...
soulng::parser::Match GuardParser::ConceptGuard(CppLexer& lexer, sngcpp::symbols::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    {
        parser_debug_match_span = lexer.GetSpan();
        soulng::lexer::WriteBeginRuleToLog(lexer, soulng::unicode::ToUtf32("ConceptGuard"));
    }
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            pass = ctx->GetFlag(sngcpp::symbols::ContextFlags::parsingConceptDefinition);
        }
        if (match.hit && !pass)
        {
            match = soulng::parser::Match(false);
    ...
    if (parser_debug_write_to_log)
    {
        if (match.hit) soulng::lexer::WriteSuccessToLog(lexer, parser_debug_match_span, soulng::unicode::ToUtf32("ConceptGuard"));
        else soulng::lexer::WriteFailureToLog(lexer, soulng::unicode::ToUtf32("ConceptGuard"));
    }
    #endif // SOULNG_PARSER_DEBUG_SUPPORT
    if (!match.hit)
    {
