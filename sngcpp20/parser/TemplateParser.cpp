...
soulng::parser::Match TemplateParser::TemplateDeclaration(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                soulng::parser::Match match = TemplateParser::TemplateHead(lexer, ctx);
                            ...
                            {
                                {
                                    ...
                                    #endif // SOULNG_PARSER_DEBUG_SUPPORT
                                    return soulng::parser::Match(true, new TemplateDeclarationNode(s, templateHead.release(), concepDefinition.release()));
                                }
                            }
                            *parentMatch6 = match;
                        }
                                    ...
                                    {
                                        {
                                            ...
                                            if (parser_debug_write_to_log) soulng::lexer::WriteSuccessToLog(lexer, parser_debug_match_span, soulng::unicode::ToUtf32("TemplateDeclaration"));
                                            #endif // SOULNG_PARSER_DEBUG_SUPPORT
                                            return soulng::parser::Match(true, new TemplateDeclarationNode(s, templateHead.release(), declaration.release()));
                                        }
                                    }
                                    *parentMatch8 = match;
                                }
...
soulng::parser::Match TemplateParser::TemplateHead(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
        ...
        {
            {
                ...
                #endif // SOULNG_PARSER_DEBUG_SUPPORT
                return soulng::parser::Match(true, new TemplateHeadNode(s, templateParamList.release(), requiresClause.release()));
            }
        }
        *parentMatch0 = match;
    }
...
soulng::parser::Match TemplateParser::TemplateParameterList(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match TemplateParser::TemplateParameter(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match TemplateParser::TypeParameter(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
                                            ...
                                            {
                                                {
                                                    ...
                                                    if (parser_debug_write_to_log) soulng::lexer::WriteSuccessToLog(lexer, parser_debug_match_span, soulng::unicode::ToUtf32("TypeParameter"));
                                                    #endif // SOULNG_PARSER_DEBUG_SUPPORT
                                                    return soulng::parser::Match(true, new TypeParameterNode(s, key.release(), identifier2.release(), nullptr, nullptr, ellipses.release(), templateHead.release()));
                                                }
                                            }
                                            *parentMatch17 = match;
                                        }
                                                    ...
                                                    {
                                                        {
                                                            ...
                                                            if (parser_debug_write_to_log) soulng::lexer::WriteSuccessToLog(lexer, parser_debug_match_span, soulng::unicode::ToUtf32("TypeParameter"));
                                                            #endif // SOULNG_PARSER_DEBUG_SUPPORT
                                                            return soulng::parser::Match(true, new TypeParameterNode(s, key2.release(), identifier3.release(), nullptr, nullptr, ellipses3.release(), nullptr));
                                                        }
                                                    }
                                                    *parentMatch36 = match;
                                                }
                                        ...
                                        soulng::parser::Match* parentMatch55 = &match;
                                        {
                                            ...
                                            soulng::parser::Match* parentMatch56 = &match;
                                            {
                                                ...
                                                soulng::parser::Match* parentMatch57 = &match;
                                                {
                                                    ...
                                                    {
                                                        soulng::parser::Match match = ExpressionParser::Ellipses(lexer);
                                                        ellipses5.reset(static_cast<Node*>(match.value));
                                                        if (match.hit)
                                                        {
                                                            *parentMatch58 = match;
                                                        }
                                            ...
                                            {
                                                {
                                                    ...
                                                    if (parser_debug_write_to_log) soulng::lexer::WriteSuccessToLog(lexer, parser_debug_match_span, soulng::unicode::ToUtf32("TypeParameter"));
                                                    #endif // SOULNG_PARSER_DEBUG_SUPPORT
                                                    return soulng::parser::Match(true, new TypeParameterNode(s, typeConstraint4.release(), identifier5.release(), nullptr, nullptr, ellipses5.release(), nullptr));
                                                }
                                            }
                                            *parentMatch55 = match;
                                        }
...
soulng::parser::Match TemplateParser::TemplateId(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match TemplateParser::SimpleTemplateId(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match TemplateParser::TemplateName(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match TemplateParser::TemplateArgumentList(CppLexer& lexer, sngcpp::par::Context* ctx, sngcpp::ast::Node* templateIdNode)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
            ...
            soulng::parser::Match* parentMatch12 = &match;
            {
                ...
                soulng::parser::Match* parentMatch13 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch14 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            templateIdNode->AddNode(new EllipsesNode(sourcePos));
                        }
                        *parentMatch14 = match;
                    }
                    *parentMatch13 = match;
...
soulng::parser::Match TemplateParser::TemplateArgument(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match TemplateParser::DeductionGuide(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match TemplateParser::ExplicitInstantiation(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
...
soulng::parser::Match TemplateParser::ExplicitSpecialization(CppLexer& lexer, sngcpp::par::Context* ctx)
{
    #ifdef SOULNG_PARSER_DEBUG_SUPPORT
    soulng::lexer::Span parser_debug_match_span;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
