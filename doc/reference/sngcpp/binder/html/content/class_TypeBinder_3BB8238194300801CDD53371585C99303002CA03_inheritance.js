...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::binder::TypeBinder", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TypeBinder_3BB8238194300801CDD53371585C99303002CA03.html" }];
    drawDiagram(classes);
}
