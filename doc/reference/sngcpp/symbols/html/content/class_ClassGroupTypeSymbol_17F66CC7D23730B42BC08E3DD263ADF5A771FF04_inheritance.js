...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::ClassGroupTypeSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ClassGroupTypeSymbol_17F66CC7D23730B42BC08E3DD263ADF5A771FF04.html" }];
    drawDiagram(classes);
}
