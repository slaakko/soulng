...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::DerivedTypeSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_DerivedTypeSymbol_A5B6245DB70735E8F1360D2AC060449B23896C4B.html" }];
    drawDiagram(classes);
}
