...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::FunctionGroupSymbol", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FunctionGroupSymbol_E07155C77C7DE8B74F98DED554ED0940EAAE9264.html" }];
    drawDiagram(classes);
}
