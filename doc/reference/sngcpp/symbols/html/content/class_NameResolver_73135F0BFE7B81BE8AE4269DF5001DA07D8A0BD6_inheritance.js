...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::NameResolver", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_NameResolver_73135F0BFE7B81BE8AE4269DF5001DA07D8A0BD6.html" }];
    drawDiagram(classes);
}
