...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::NamespaceSymbol", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_NamespaceSymbol_0C21C66C7D5F4EB5059F0E38A6C2549610675086.html" }];
    drawDiagram(classes);
}
