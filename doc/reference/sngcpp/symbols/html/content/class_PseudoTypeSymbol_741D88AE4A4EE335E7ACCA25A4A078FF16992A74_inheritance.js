...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::PseudoTypeSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PseudoTypeSymbol_741D88AE4A4EE335E7ACCA25A4A078FF16992A74.html" }];
    drawDiagram(classes);
}
