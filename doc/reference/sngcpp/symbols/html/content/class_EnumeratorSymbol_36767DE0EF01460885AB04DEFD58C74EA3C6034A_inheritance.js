...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::EnumeratorSymbol", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_EnumeratorSymbol_36767DE0EF01460885AB04DEFD58C74EA3C6034A.html" }];
    drawDiagram(classes);
}
