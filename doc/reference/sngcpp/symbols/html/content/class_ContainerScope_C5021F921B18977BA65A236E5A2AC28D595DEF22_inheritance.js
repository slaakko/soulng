...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "sngcpp::symbols::Scope", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_Scope_4A388D81B8230FB546BC8D146C3D8492959286FB.html" },
        { name: "sngcpp::symbols::ContainerScope", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ContainerScope_C5021F921B18977BA65A236E5A2AC28D595DEF22.html" }];
    drawDiagram(classes);
}
