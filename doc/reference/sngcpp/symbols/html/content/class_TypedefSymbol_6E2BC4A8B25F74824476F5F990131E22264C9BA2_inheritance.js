...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::TypedefSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_TypedefSymbol_6E2BC4A8B25F74824476F5F990131E22264C9BA2.html" }];
    drawDiagram(classes);
}
