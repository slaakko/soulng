...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::IntegerLiteralTypeSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_IntegerLiteralTypeSymbol_30260614C598B4E861119D6434267E2F40F526F9.html" }];
    drawDiagram(classes);
}
