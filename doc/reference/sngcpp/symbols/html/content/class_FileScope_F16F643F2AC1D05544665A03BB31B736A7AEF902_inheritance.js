...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::FileScope", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FileScope_F16F643F2AC1D05544665A03BB31B736A7AEF902.html" }];
    drawDiagram(classes);
}
