...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::ElaborateClassTypeSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ElaborateClassTypeSymbol_9241D239DC0CDC5B9451173D050D838C9A8B4457.html" }];
    drawDiagram(classes);
}
