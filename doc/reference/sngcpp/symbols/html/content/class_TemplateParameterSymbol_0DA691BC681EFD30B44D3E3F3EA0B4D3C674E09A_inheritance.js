...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::TemplateParameterSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_TemplateParameterSymbol_0DA691BC681EFD30B44D3E3F3EA0B4D3C674E09A.html" }];
    drawDiagram(classes);
}
