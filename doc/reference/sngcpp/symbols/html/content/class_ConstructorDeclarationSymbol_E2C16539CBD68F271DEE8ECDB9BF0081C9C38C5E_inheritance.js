...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::ConstructorDeclarationSymbol", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_ConstructorDeclarationSymbol_E2C16539CBD68F271DEE8ECDB9BF0081C9C38C5E.html" }];
    drawDiagram(classes);
}
