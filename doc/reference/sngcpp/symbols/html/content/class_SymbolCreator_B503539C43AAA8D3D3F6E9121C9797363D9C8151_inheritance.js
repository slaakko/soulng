...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::SymbolCreator", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SymbolCreator_B503539C43AAA8D3D3F6E9121C9797363D9C8151.html" }];
    drawDiagram(classes);
}
