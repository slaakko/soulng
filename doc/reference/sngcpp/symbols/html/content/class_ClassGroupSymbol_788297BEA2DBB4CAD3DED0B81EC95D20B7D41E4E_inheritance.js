...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::ClassGroupSymbol", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ClassGroupSymbol_788297BEA2DBB4CAD3DED0B81EC95D20B7D41E4E.html" }];
    drawDiagram(classes);
}
