...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::LambdaExpressionSymbol", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_LambdaExpressionSymbol_18B7D83302A73F8DB16D599B39A49C9724862CF6.html" }];
    drawDiagram(classes);
}
