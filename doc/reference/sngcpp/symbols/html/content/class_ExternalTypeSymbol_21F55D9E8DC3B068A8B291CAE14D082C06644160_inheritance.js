...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::ExternalTypeSymbol", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ExternalTypeSymbol_21F55D9E8DC3B068A8B291CAE14D082C06644160.html" }];
    drawDiagram(classes);
}
