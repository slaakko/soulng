...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::DeclarationBlockSymbol", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DeclarationBlockSymbol_5BD234D3A5E98C669B777BB27B7A117B3E7F87C5.html" }];
    drawDiagram(classes);
}
