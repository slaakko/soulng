...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::GrammarSymbol", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GrammarSymbol_B430A5A85FDF7D550BDFB017288A82F98E2D5DA8.html" }];
    drawDiagram(classes);
}
