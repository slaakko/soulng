...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::ParameterSymbol", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ParameterSymbol_5ECE6B04CC7840379250651CF304DD87C1235AAD.html" }];
    drawDiagram(classes);
}
