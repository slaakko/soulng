...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::symbols::RuleSymbol", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RuleSymbol_9A9C4D1DED62C565AE48DD3ECC68C1A9528D97C8.html" }];
    drawDiagram(classes);
}
