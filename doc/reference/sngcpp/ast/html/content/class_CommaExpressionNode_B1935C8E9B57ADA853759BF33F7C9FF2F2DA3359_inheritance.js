...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::CommaExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_CommaExpressionNode_B1935C8E9B57ADA853759BF33F7C9FF2F2DA3359.html" }];
    drawDiagram(classes);
}
