...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::UsingDirectiveNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_UsingDirectiveNode_A0CBB938BF2FC81F8B1D12066937ABD2455063C2.html" }];
    drawDiagram(classes);
}
