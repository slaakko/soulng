...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::LambdaExpressionNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_LambdaExpressionNode_8EAB242A1154BEB49E6CDEB72EEFA86405D54C07.html" }];
    drawDiagram(classes);
}
