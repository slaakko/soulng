...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::TemplateDeclarationNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TemplateDeclarationNode_C3E60CC2D83CB6A8AD00E259AC31ECADBECE6569.html" }];
    drawDiagram(classes);
}
