...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ElaborateClassNameNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ElaborateClassNameNode_F210D8E4ED4CC6B925B3259D6669155B89B07E80.html" }];
    drawDiagram(classes);
}
