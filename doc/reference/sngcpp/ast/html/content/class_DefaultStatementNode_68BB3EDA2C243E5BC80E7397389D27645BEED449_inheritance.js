...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::DefaultStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DefaultStatementNode_68BB3EDA2C243E5BC80E7397389D27645BEED449.html" }];
    drawDiagram(classes);
}
