...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::CaseStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_CaseStatementNode_94117DE63309113D0C69F113C5C67B0EC893BB4A.html" }];
    drawDiagram(classes);
}
