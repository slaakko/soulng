...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::NewExpressionNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_NewExpressionNode_6CE8CBB219536BBB5618356B7338DFFD655FC9A1.html" }];
    drawDiagram(classes);
}
