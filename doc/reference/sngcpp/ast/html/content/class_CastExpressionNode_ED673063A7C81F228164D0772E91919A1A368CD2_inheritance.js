...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::CastExpressionNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CastExpressionNode_ED673063A7C81F228164D0772E91919A1A368CD2.html" }];
    drawDiagram(classes);
}
