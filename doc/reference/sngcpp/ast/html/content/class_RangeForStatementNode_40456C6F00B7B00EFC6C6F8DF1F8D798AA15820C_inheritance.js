...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::RangeForStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RangeForStatementNode_40456C6F00B7B00EFC6C6F8DF1F8D798AA15820C.html" }];
    drawDiagram(classes);
}
