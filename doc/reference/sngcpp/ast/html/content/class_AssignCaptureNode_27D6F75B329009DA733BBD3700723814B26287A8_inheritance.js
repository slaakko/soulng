...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::AssignCaptureNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_AssignCaptureNode_27D6F75B329009DA733BBD3700723814B26287A8.html" }];
    drawDiagram(classes);
}
