...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ExpressionInitializerNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ExpressionInitializerNode_83257C3B408A211519A78BB4C1268CF7106F49A0.html" }];
    drawDiagram(classes);
}
