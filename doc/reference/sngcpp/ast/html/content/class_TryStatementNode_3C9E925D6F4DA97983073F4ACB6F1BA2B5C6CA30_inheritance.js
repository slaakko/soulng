...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::TryStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TryStatementNode_3C9E925D6F4DA97983073F4ACB6F1BA2B5C6CA30.html" }];
    drawDiagram(classes);
}
