...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::RValueRefNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_RValueRefNode_69543375254B64F0CC387CA5032AACFCE16B1F24.html" }];
    drawDiagram(classes);
}
