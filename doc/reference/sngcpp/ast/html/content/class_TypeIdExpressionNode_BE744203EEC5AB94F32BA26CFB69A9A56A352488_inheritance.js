...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::TypeIdExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_TypeIdExpressionNode_BE744203EEC5AB94F32BA26CFB69A9A56A352488.html" }];
    drawDiagram(classes);
}
