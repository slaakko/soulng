...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::InitDeclaratorNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_InitDeclaratorNode_0B94468547B968BA2C0286E75A8DC28EECA494C8.html" }];
    drawDiagram(classes);
}
