...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::RefCaptureNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RefCaptureNode_6A83281EA99E3F76D072BFBB9BCD8196A8E6093A.html" }];
    drawDiagram(classes);
}
