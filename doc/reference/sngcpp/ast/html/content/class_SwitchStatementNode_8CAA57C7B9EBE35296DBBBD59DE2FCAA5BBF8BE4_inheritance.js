...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::SwitchStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SwitchStatementNode_8CAA57C7B9EBE35296DBBBD59DE2FCAA5BBF8BE4.html" }];
    drawDiagram(classes);
}
