...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::StringLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_StringLiteralNode_E59FD9270159D449531083CDA21AEEF7DA5181B3.html" }];
    drawDiagram(classes);
}
