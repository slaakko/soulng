...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::NullPtrLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_NullPtrLiteralNode_EF8568FAD69A4B635C56E0F94DA3E75CB9E76100.html" }];
    drawDiagram(classes);
}
