...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::LinkageSpecificationNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_LinkageSpecificationNode_D8A925830B1217F15E8926C048493F535A59AAA5.html" }];
    drawDiagram(classes);
}
