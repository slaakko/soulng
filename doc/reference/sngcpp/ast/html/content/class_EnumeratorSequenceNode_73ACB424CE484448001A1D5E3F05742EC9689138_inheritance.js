...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::EnumeratorSequenceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_EnumeratorSequenceNode_73ACB424CE484448001A1D5E3F05742EC9689138.html" }];
    drawDiagram(classes);
}
