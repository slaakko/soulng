...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::IntegerLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_IntegerLiteralNode_9474DF73DF5CD9D4919AF57C69EA261851CD09A0.html" }];
    drawDiagram(classes);
}
