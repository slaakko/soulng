...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::VolatileNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_VolatileNode_FF7BC932368393C334F366B0BD1BB2A9EB058085.html" }];
    drawDiagram(classes);
}
