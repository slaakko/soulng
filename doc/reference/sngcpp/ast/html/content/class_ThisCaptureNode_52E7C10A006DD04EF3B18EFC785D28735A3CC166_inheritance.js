...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ThisCaptureNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ThisCaptureNode_52E7C10A006DD04EF3B18EFC785D28735A3CC166.html" }];
    drawDiagram(classes);
}
