...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::SpecialMemberFunctionNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SpecialMemberFunctionNode_1D50B1136366D0CDE9B8D4AA3E814A81BBF0C2FD.html" }];
    drawDiagram(classes);
}
