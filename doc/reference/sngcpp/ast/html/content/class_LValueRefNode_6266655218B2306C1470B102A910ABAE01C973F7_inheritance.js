...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::LValueRefNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_LValueRefNode_6266655218B2306C1470B102A910ABAE01C973F7.html" }];
    drawDiagram(classes);
}
