...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ParameterSequenceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ParameterSequenceNode_2250E2D13F65B085EBA0A00FEC18439190DBB411.html" }];
    drawDiagram(classes);
}
