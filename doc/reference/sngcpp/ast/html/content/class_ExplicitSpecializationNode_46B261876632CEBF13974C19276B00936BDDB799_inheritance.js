...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ExplicitSpecializationNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ExplicitSpecializationNode_46B261876632CEBF13974C19276B00936BDDB799.html" }];
    drawDiagram(classes);
}
