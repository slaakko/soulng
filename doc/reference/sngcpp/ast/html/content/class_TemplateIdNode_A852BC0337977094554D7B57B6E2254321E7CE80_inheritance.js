...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::TemplateIdNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TemplateIdNode_A852BC0337977094554D7B57B6E2254321E7CE80.html" }];
    drawDiagram(classes);
}
