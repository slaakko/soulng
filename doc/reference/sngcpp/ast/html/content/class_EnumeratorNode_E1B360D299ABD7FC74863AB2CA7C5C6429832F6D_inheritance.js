...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::EnumeratorNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_EnumeratorNode_E1B360D299ABD7FC74863AB2CA7C5C6429832F6D.html" }];
    drawDiagram(classes);
}
