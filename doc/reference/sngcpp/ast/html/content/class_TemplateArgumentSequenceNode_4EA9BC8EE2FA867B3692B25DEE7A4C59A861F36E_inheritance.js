...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::TemplateArgumentSequenceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_TemplateArgumentSequenceNode_4EA9BC8EE2FA867B3692B25DEE7A4C59A861F36E.html" }];
    drawDiagram(classes);
}
