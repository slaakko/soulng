...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ForwardClassDeclarationNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ForwardClassDeclarationNode_A32432C5F18582F38A1566FE283383F06373D527.html" }];
    drawDiagram(classes);
}
