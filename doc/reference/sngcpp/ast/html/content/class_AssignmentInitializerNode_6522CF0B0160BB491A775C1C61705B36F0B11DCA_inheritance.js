...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::AssignmentInitializerNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_AssignmentInitializerNode_6522CF0B0160BB491A775C1C61705B36F0B11DCA.html" }];
    drawDiagram(classes);
}
