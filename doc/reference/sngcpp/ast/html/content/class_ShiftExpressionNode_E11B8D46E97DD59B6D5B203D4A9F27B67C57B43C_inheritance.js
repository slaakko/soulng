...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ShiftExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ShiftExpressionNode_E11B8D46E97DD59B6D5B203D4A9F27B67C57B43C.html" }];
    drawDiagram(classes);
}
