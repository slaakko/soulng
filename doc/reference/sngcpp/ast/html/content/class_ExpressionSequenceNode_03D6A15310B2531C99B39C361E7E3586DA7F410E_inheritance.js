...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ExpressionSequenceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ExpressionSequenceNode_03D6A15310B2531C99B39C361E7E3586DA7F410E.html" }];
    drawDiagram(classes);
}
