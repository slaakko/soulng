...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::MultiplicativeExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_MultiplicativeExpressionNode_194B2D3A8A640406E728FE4BAD0E8C5AC7A46EA5.html" }];
    drawDiagram(classes);
}
