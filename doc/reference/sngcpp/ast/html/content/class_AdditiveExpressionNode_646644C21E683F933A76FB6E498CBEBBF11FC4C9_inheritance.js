...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::AdditiveExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_AdditiveExpressionNode_646644C21E683F933A76FB6E498CBEBBF11FC4C9.html" }];
    drawDiagram(classes);
}
