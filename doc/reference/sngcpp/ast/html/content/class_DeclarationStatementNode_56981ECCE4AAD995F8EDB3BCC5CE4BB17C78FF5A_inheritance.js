...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::DeclarationStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DeclarationStatementNode_56981ECCE4AAD995F8EDB3BCC5CE4BB17C78FF5A.html" }];
    drawDiagram(classes);
}
