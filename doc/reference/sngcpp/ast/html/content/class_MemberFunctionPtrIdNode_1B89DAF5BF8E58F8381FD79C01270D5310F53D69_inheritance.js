...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::MemberFunctionPtrIdNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_MemberFunctionPtrIdNode_1B89DAF5BF8E58F8381FD79C01270D5310F53D69.html" }];
    drawDiagram(classes);
}
