...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::TemplateArgumentNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TemplateArgumentNode_2E97CF467782F7D519085603AD7A6F979CF62941.html" }];
    drawDiagram(classes);
}
