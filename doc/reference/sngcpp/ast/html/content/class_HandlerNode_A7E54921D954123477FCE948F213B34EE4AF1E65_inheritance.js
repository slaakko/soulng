...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::HandlerNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_HandlerNode_A7E54921D954123477FCE948F213B34EE4AF1E65.html" }];
    drawDiagram(classes);
}
