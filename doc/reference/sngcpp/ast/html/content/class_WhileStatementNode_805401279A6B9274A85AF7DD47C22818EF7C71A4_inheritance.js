...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::WhileStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_WhileStatementNode_805401279A6B9274A85AF7DD47C22818EF7C71A4.html" }];
    drawDiagram(classes);
}
