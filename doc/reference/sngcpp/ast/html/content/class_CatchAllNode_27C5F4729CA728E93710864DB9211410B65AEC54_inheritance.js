...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::CatchAllNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CatchAllNode_27C5F4729CA728E93710864DB9211410B65AEC54.html" }];
    drawDiagram(classes);
}
