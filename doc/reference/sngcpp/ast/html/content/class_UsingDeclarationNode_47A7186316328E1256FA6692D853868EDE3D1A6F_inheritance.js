...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::UsingDeclarationNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_UsingDeclarationNode_47A7186316328E1256FA6692D853868EDE3D1A6F.html" }];
    drawDiagram(classes);
}
