...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::OperatorFunctionIdNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_OperatorFunctionIdNode_2FB359DA0330D9E3C94408C0726F3C660035FA1B.html" }];
    drawDiagram(classes);
}
