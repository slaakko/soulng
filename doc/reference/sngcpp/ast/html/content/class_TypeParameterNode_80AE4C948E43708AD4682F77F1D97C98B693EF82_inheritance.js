...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::TypeParameterNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TypeParameterNode_80AE4C948E43708AD4682F77F1D97C98B693EF82.html" }];
    drawDiagram(classes);
}
