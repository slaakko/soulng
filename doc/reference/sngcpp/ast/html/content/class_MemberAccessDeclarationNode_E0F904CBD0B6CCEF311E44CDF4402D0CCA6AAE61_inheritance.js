...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::MemberAccessDeclarationNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_MemberAccessDeclarationNode_E0F904CBD0B6CCEF311E44CDF4402D0CCA6AAE61.html" }];
    drawDiagram(classes);
}
