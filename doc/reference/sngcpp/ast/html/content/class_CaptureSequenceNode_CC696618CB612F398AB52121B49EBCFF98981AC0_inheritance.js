...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::CaptureSequenceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_CaptureSequenceNode_CC696618CB612F398AB52121B49EBCFF98981AC0.html" }];
    drawDiagram(classes);
}
