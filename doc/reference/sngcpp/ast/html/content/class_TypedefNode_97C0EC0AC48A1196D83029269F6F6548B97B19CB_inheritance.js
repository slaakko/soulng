...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::TypedefNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_TypedefNode_97C0EC0AC48A1196D83029269F6F6548B97B19CB.html" }];
    drawDiagram(classes);
}
