...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::AndExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_AndExpressionNode_EAA6E87D0F37B6C3E51FF2229988ECACD7CB19B1.html" }];
    drawDiagram(classes);
}
