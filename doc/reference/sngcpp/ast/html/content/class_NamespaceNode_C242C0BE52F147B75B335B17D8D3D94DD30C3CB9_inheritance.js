...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::NamespaceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_NamespaceNode_C242C0BE52F147B75B335B17D8D3D94DD30C3CB9.html" }];
    drawDiagram(classes);
}
