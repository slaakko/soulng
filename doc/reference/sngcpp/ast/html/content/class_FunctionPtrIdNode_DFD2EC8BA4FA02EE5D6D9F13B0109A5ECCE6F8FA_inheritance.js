...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::FunctionPtrIdNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FunctionPtrIdNode_DFD2EC8BA4FA02EE5D6D9F13B0109A5ECCE6F8FA.html" }];
    drawDiagram(classes);
}
