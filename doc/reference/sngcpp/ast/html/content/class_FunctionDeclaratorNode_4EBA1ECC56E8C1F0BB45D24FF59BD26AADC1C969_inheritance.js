...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::FunctionDeclaratorNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FunctionDeclaratorNode_4EBA1ECC56E8C1F0BB45D24FF59BD26AADC1C969.html" }];
    drawDiagram(classes);
}
