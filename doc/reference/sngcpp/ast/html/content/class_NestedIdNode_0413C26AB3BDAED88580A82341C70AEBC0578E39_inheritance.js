...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::NestedIdNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_NestedIdNode_0413C26AB3BDAED88580A82341C70AEBC0578E39.html" }];
    drawDiagram(classes);
}
