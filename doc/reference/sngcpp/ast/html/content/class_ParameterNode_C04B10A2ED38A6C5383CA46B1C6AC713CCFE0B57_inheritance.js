...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ParameterNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ParameterNode_C04B10A2ED38A6C5383CA46B1C6AC713CCFE0B57.html" }];
    drawDiagram(classes);
}
