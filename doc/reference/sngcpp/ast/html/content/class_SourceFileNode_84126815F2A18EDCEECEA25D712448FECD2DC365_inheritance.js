...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::SourceFileNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SourceFileNode_84126815F2A18EDCEECEA25D712448FECD2DC365.html" }];
    drawDiagram(classes);
}
