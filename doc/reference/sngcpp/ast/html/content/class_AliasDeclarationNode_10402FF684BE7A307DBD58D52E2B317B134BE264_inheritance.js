...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::AliasDeclarationNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_AliasDeclarationNode_10402FF684BE7A307DBD58D52E2B317B134BE264.html" }];
    drawDiagram(classes);
}
