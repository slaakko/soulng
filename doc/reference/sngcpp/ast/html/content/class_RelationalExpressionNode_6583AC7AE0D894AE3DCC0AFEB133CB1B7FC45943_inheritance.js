...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::RelationalExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_RelationalExpressionNode_6583AC7AE0D894AE3DCC0AFEB133CB1B7FC45943.html" }];
    drawDiagram(classes);
}
