...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::IfStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_IfStatementNode_690F01C4A6AF4447794F72C75179CF3D3449FDBD.html" }];
    drawDiagram(classes);
}
