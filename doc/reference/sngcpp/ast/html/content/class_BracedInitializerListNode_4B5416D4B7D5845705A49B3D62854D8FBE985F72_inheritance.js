...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::BracedInitializerListNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_BracedInitializerListNode_4B5416D4B7D5845705A49B3D62854D8FBE985F72.html" }];
    drawDiagram(classes);
}
