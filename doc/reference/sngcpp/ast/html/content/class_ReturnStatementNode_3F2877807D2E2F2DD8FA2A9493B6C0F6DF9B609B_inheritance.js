...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ReturnStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ReturnStatementNode_3F2877807D2E2F2DD8FA2A9493B6C0F6DF9B609B.html" }];
    drawDiagram(classes);
}
