...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::FunctionNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_FunctionNode_FF33E683A8B619C8B0C68E2611A5570F3A4BADD6.html" }];
    drawDiagram(classes);
}
