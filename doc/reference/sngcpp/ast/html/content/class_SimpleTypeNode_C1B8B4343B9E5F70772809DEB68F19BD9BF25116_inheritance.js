...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::SimpleTypeNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SimpleTypeNode_C1B8B4343B9E5F70772809DEB68F19BD9BF25116.html" }];
    drawDiagram(classes);
}
