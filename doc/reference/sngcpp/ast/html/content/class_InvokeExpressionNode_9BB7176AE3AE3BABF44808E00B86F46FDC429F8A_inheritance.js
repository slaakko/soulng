...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::InvokeExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_InvokeExpressionNode_9BB7176AE3AE3BABF44808E00B86F46FDC429F8A.html" }];
    drawDiagram(classes);
}
