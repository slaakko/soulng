...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::EqualityExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_EqualityExpressionNode_451EFFA2481F9F45A091C4CF6FBC0BEAF8A243E1.html" }];
    drawDiagram(classes);
}
