...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ContinueStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ContinueStatementNode_CF7A182D0616CF9AB87E5358217C29E485C58A96.html" }];
    drawDiagram(classes);
}
