...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ExplicitInstantiationNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ExplicitInstantiationNode_A4EE268EBC326C26A8E30AD0220D444DC5CA58FA.html" }];
    drawDiagram(classes);
}
