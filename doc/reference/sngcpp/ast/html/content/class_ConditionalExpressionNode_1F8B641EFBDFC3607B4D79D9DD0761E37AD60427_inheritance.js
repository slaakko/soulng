...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ConditionalExpressionNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ConditionalExpressionNode_1F8B641EFBDFC3607B4D79D9DD0761E37AD60427.html" }];
    drawDiagram(classes);
}
