...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::UnaryExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_UnaryExpressionNode_0158205C576BD308E68A0A8F334BB20449473A4E.html" }];
    drawDiagram(classes);
}
