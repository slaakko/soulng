...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::CppCastExpressionNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CppCastExpressionNode_184B9A0ABA8D688BBC71A32F1AA792C86622D1AF.html" }];
    drawDiagram(classes);
}
