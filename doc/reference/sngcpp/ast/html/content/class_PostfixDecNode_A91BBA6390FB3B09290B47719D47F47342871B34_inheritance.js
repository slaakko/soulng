...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::PostfixDecNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_PostfixDecNode_A91BBA6390FB3B09290B47719D47F47342871B34.html" }];
    drawDiagram(classes);
}
