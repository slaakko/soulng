...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::InclusiveOrExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_InclusiveOrExpressionNode_3214ECBF632686F7B1700FA0723AD8D07D7C032E.html" }];
    drawDiagram(classes);
}
