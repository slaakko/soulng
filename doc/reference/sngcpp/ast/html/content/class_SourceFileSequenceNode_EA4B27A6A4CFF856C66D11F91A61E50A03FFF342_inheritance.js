...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::SourceFileSequenceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_SourceFileSequenceNode_EA4B27A6A4CFF856C66D11F91A61E50A03FFF342.html" }];
    drawDiagram(classes);
}
