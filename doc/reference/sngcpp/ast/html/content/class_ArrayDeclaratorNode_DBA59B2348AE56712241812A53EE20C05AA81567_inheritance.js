...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ArrayDeclaratorNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ArrayDeclaratorNode_DBA59B2348AE56712241812A53EE20C05AA81567.html" }];
    drawDiagram(classes);
}
