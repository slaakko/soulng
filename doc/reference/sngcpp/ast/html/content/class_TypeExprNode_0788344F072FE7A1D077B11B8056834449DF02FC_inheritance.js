...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::TypeExprNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_TypeExprNode_0788344F072FE7A1D077B11B8056834449DF02FC.html" }];
    drawDiagram(classes);
}
