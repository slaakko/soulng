...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::GotoStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GotoStatementNode_EAE07B7FF6164B75BAD09B2E9949D33FEED91652.html" }];
    drawDiagram(classes);
}
