...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::BreakStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_BreakStatementNode_D907D6C137DC609E987B2A9EC4418DE2E42DE210.html" }];
    drawDiagram(classes);
}
