...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ForStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ForStatementNode_E9C60AE4EA25A10C9746D6E6B2184D6B49D306D6.html" }];
    drawDiagram(classes);
}
