...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ExpressionStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ExpressionStatementNode_214B8E296B636ADE9D97717653DF813740CD49D4.html" }];
    drawDiagram(classes);
}
