...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::FloatingLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_FloatingLiteralNode_64B74382B3EE97349C8DBCFAB39E9C5DA2C736AD.html" }];
    drawDiagram(classes);
}
