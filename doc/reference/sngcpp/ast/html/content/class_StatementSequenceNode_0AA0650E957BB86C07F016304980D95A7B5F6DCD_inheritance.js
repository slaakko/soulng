...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::StatementSequenceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_StatementSequenceNode_0AA0650E957BB86C07F016304980D95A7B5F6DCD.html" }];
    drawDiagram(classes);
}
