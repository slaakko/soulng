...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::EnumTypeNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_EnumTypeNode_742B6AEC3845ABAF76692A4CA17EB41A26B488F5.html" }];
    drawDiagram(classes);
}
