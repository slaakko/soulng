...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::BooleanLiteralNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_BooleanLiteralNode_BC61A09A5B5F1E23183E1D1C39DD5C2EBA004334.html" }];
    drawDiagram(classes);
}
