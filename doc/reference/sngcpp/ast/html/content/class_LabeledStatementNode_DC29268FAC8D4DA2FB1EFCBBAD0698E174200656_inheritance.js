...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::LabeledStatementNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_LabeledStatementNode_DC29268FAC8D4DA2FB1EFCBBAD0698E174200656.html" }];
    drawDiagram(classes);
}
