...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::MemberInitializerNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_MemberInitializerNode_36375DAC454AA7FDEAA5CEDD10015FE9759D6D3D.html" }];
    drawDiagram(classes);
}
