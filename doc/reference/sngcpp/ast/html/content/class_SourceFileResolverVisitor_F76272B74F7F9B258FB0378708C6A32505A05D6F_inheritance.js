...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "sngcpp::ast::Visitor", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_Visitor_344553F56B950DE252EE7B103A0A9ABF2B6733AD.html" },
        { name: "sngcpp::ast::SourceFileResolverVisitor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SourceFileResolverVisitor_F76272B74F7F9B258FB0378708C6A32505A05D6F.html" }];
    drawDiagram(classes);
}
