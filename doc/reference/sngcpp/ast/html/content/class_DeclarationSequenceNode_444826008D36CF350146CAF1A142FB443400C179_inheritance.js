...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::DeclarationSequenceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DeclarationSequenceNode_444826008D36CF350146CAF1A142FB443400C179.html" }];
    drawDiagram(classes);
}
