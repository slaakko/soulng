...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::SubscriptExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_SubscriptExpressionNode_9DD145DD7A819CC1ECC448AF56862BD71C90388A.html" }];
    drawDiagram(classes);
}
