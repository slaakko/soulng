...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::MemberDeclarationNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_MemberDeclarationNode_44B15F34178D45004B25CEBCFF8ABF790AC48516.html" }];
    drawDiagram(classes);
}
