...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::SimpleDeclarationNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SimpleDeclarationNode_62E86E1DA1C4D0792046C5FF5A06FAD1A51675E1.html" }];
    drawDiagram(classes);
}
