...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::DtorIdNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DtorIdNode_32B67D45C36C631B4214A2A2E50E359F07B8E7B7.html" }];
    drawDiagram(classes);
}
