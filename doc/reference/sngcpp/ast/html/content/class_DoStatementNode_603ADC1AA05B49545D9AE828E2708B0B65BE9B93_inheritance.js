...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::DoStatementNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_DoStatementNode_603ADC1AA05B49545D9AE828E2708B0B65BE9B93.html" }];
    drawDiagram(classes);
}
