...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ExclusiveOrExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ExclusiveOrExpressionNode_3ABD305C501DFD212FF1FCD79B68D38A0738F02E.html" }];
    drawDiagram(classes);
}
