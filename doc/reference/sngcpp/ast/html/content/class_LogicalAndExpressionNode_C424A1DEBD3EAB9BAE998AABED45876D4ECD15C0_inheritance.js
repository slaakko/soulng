...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::LogicalAndExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_LogicalAndExpressionNode_C424A1DEBD3EAB9BAE998AABED45876D4ECD15C0.html" }];
    drawDiagram(classes);
}
