...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::ParenthesizedExprNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ParenthesizedExprNode_A72F58521E415F4D3B8D0DC26418D8B3FEBECDE1.html" }];
    drawDiagram(classes);
}
