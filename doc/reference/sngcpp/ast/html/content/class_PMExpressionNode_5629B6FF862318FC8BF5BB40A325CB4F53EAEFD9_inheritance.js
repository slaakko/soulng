...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::PMExpressionNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_PMExpressionNode_5629B6FF862318FC8BF5BB40A325CB4F53EAEFD9.html" }];
    drawDiagram(classes);
}
