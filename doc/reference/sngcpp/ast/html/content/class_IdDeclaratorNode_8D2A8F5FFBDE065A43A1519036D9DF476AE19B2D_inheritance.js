...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::IdDeclaratorNode", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_IdDeclaratorNode_8D2A8F5FFBDE065A43A1519036D9DF476AE19B2D.html" }];
    drawDiagram(classes);
}
