...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sngcpp::ast::MemberInitializerSequenceNode", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_MemberInitializerSequenceNode_97F2CC1363114BA6A6B2CE536B21C9825288B45E.html" }];
    drawDiagram(classes);
}
