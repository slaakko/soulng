...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "cpp2cm::Patch", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./class_Patch_70B08928AFE9041B9D7D47BD77C7EC9850B63A8C.html" },
        { name: "cpp2cm::ModifyPatch", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ModifyPatch_767D44ED5FA64ED06104C53D56F73783448A43E4.html" }];
    drawDiagram(classes);
}
