...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::PreIncrementExpr", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PreIncrementExpr_4E1B5BDEBD5DD530F5C1AA274D4FFFC8CBC5BB99.html" }];
    drawDiagram(classes);
}
