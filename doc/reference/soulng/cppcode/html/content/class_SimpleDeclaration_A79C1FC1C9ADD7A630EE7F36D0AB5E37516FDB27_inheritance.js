...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::SimpleDeclaration", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_SimpleDeclaration_A79C1FC1C9ADD7A630EE7F36D0AB5E37516FDB27.html" }];
    drawDiagram(classes);
}
