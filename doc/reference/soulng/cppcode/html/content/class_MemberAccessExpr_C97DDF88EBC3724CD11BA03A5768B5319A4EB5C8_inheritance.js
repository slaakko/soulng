...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::MemberAccessExpr", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_MemberAccessExpr_C97DDF88EBC3724CD11BA03A5768B5319A4EB5C8.html" }];
    drawDiagram(classes);
}
