...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::InvokeExpr", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_InvokeExpr_471267A59BD7CACA97DC27B8D146378CEF2A6413.html" }];
    drawDiagram(classes);
}
