...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::NamespaceAlias", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_NamespaceAlias_54FEF7F2329664BA018DA644DF7DCAB9F222A7A3.html" }];
    drawDiagram(classes);
}
