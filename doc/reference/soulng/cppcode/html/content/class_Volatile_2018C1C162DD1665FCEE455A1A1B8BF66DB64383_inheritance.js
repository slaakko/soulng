...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::TypeSpecifier", id: "class_2", level: 2, subject: false, hasDerivedClasses: true, link: "./class_TypeSpecifier_61154F991BC5F0683D42B983260812D492480BA5.html" },
        { name: "soulng::cppcode::Volatile", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_Volatile_2018C1C162DD1665FCEE455A1A1B8BF66DB64383.html" }];
    drawDiagram(classes);
}
