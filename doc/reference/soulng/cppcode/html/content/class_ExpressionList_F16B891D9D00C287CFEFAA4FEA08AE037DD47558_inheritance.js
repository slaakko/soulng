...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::ExpressionList", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ExpressionList_F16B891D9D00C287CFEFAA4FEA08AE037DD47558.html" }];
    drawDiagram(classes);
}
