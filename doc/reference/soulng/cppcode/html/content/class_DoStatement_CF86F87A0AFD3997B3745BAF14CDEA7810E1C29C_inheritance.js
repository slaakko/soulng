...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::DoStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_DoStatement_CF86F87A0AFD3997B3745BAF14CDEA7810E1C29C.html" }];
    drawDiagram(classes);
}
