...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::Initializer", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_Initializer_E7849535337E9735E13262B2FE8C0BE12A7DFC20.html" }];
    drawDiagram(classes);
}
