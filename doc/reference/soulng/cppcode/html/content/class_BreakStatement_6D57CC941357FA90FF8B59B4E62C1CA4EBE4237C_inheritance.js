...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::BreakStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_BreakStatement_6D57CC941357FA90FF8B59B4E62C1CA4EBE4237C.html" }];
    drawDiagram(classes);
}
