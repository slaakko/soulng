...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::PreDecrementExpr", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_PreDecrementExpr_58D06F4C1857DC9A078671250853232774B2D518.html" }];
    drawDiagram(classes);
}
