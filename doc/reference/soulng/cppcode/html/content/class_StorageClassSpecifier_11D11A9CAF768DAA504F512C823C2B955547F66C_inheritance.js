...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::StorageClassSpecifier", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_StorageClassSpecifier_11D11A9CAF768DAA504F512C823C2B955547F66C.html" }];
    drawDiagram(classes);
}
