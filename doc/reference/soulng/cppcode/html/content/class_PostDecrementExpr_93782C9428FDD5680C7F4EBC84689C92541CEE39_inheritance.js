...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::PostDecrementExpr", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_PostDecrementExpr_93782C9428FDD5680C7F4EBC84689C92541CEE39.html" }];
    drawDiagram(classes);
}
