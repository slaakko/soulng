...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::ConditionWithDeclarator", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ConditionWithDeclarator_F15EB583611320C3552113D0204DE4016708D16B.html" }];
    drawDiagram(classes);
}
