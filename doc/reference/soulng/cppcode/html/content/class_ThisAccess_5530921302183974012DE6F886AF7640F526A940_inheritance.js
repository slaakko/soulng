...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::ThisAccess", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ThisAccess_5530921302183974012DE6F886AF7640F526A940.html" }];
    drawDiagram(classes);
}
