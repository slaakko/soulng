...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::PostCastExpr", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_PostCastExpr_3C6F3517982DB78B29FF968B46918AAE680AEEF2.html" }];
    drawDiagram(classes);
}
