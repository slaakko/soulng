...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::EmptyStatement", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_EmptyStatement_DAB1B86803A4C243B97FBC701C930B96BECE5CFE.html" }];
    drawDiagram(classes);
}
