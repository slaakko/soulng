...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::ThrowExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ThrowExpr_F343AD7F8955FB60D6040DE0F9A8AC7D1AC49AA9.html" }];
    drawDiagram(classes);
}
