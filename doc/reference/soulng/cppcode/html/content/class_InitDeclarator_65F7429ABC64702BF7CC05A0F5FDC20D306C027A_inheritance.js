...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::InitDeclarator", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_InitDeclarator_65F7429ABC64702BF7CC05A0F5FDC20D306C027A.html" }];
    drawDiagram(classes);
}
