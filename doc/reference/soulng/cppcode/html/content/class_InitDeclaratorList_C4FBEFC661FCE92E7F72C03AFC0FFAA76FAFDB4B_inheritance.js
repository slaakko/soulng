...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::InitDeclaratorList", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_InitDeclaratorList_C4FBEFC661FCE92E7F72C03AFC0FFAA76FAFDB4B.html" }];
    drawDiagram(classes);
}
