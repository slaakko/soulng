...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::UnaryOpExpr", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_UnaryOpExpr_67D1B16A9C79AFD1D7DCC9256C4953AF32EE00F3.html" }];
    drawDiagram(classes);
}
