...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::CaseStatement", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_CaseStatement_60B7413117DED64DD5E9F328992C0E79BF034416.html" }];
    drawDiagram(classes);
}
