...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::PtrMemberAccessExpr", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_PtrMemberAccessExpr_03A19650693911FFC273A02319052A65F13E1B20.html" }];
    drawDiagram(classes);
}
