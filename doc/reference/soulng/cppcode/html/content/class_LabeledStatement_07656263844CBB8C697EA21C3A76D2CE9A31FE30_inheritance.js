...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::LabeledStatement", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_LabeledStatement_07656263844CBB8C697EA21C3A76D2CE9A31FE30.html" }];
    drawDiagram(classes);
}
