...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::GotoStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_GotoStatement_AF8BF441A96C2E64D00E0C2D2BF359053708D250.html" }];
    drawDiagram(classes);
}
