...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::ExceptionDeclaration", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_ExceptionDeclaration_2615669B97BBE1E8119C7F8C7CA91FEAA6089654.html" }];
    drawDiagram(classes);
}
