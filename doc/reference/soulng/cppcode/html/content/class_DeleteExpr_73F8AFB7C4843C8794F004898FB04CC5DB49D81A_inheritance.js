...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::DeleteExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DeleteExpr_73F8AFB7C4843C8794F004898FB04CC5DB49D81A.html" }];
    drawDiagram(classes);
}
