...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::AssignInit", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_AssignInit_E3F7396103AAE34455E2B7F02A47C461F9AD6C15.html" }];
    drawDiagram(classes);
}
