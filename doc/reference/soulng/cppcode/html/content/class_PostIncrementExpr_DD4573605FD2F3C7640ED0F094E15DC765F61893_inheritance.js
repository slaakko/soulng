...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::PostIncrementExpr", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_PostIncrementExpr_DD4573605FD2F3C7640ED0F094E15DC765F61893.html" }];
    drawDiagram(classes);
}
