...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::ReturnStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ReturnStatement_1E10BABA11E38437C42B7E8FC834949651382BB9.html" }];
    drawDiagram(classes);
}
