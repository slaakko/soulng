...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::DefaultStatement", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DefaultStatement_D081110C2ABB4B8842017387DCC99D95D31DED36.html" }];
    drawDiagram(classes);
}
