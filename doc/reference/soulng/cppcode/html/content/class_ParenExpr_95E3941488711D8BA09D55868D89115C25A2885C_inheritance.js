...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::ParenExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ParenExpr_95E3941488711D8BA09D55868D89115C25A2885C.html" }];
    drawDiagram(classes);
}
