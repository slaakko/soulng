...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::DeclarationStatement", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DeclarationStatement_5880FBBCD5325E5846DD724157CD1C37C34F90DA.html" }];
    drawDiagram(classes);
}
