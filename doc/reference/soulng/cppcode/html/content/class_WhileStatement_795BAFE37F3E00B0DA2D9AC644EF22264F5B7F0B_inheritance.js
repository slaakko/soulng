...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::WhileStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_WhileStatement_795BAFE37F3E00B0DA2D9AC644EF22264F5B7F0B.html" }];
    drawDiagram(classes);
}
