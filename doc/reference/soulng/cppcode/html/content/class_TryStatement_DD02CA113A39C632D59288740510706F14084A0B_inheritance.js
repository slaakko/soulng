...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::TryStatement", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_TryStatement_DD02CA113A39C632D59288740510706F14084A0B.html" }];
    drawDiagram(classes);
}
