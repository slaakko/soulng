...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::ForStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ForStatement_F8E284EFD73476E95E843C7754C64923B742DA1E.html" }];
    drawDiagram(classes);
}
