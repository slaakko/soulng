...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::IndexExpr", id: "class_4", level: 4, subject: true, hasDerivedClasses: false, link: "./class_IndexExpr_774F05AF147C08C14140554436F0E101320DD986.html" }];
    drawDiagram(classes);
}
