...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::CastExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_CastExpr_63E05C34F867196C1731C27DF561821391485992.html" }];
    drawDiagram(classes);
}
