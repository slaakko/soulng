...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::ExpressionStatement", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ExpressionStatement_3B9D1171F14B176646917AF6DDCEBD760C1E9166.html" }];
    drawDiagram(classes);
}
