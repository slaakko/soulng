...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::JumpStatement", id: "class_2", level: 2, subject: false, hasDerivedClasses: true, link: "./class_JumpStatement_9404BE633875769C6B4EB2F1879CEAF4666C5357.html" },
        { name: "soulng::cppcode::ContinueStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_ContinueStatement_EE65E1E91311ED89BEFEB77BD286663F8D44B6AD.html" }];
    drawDiagram(classes);
}
