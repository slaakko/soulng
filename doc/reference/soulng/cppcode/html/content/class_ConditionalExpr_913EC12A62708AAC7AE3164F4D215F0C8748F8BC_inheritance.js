...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::ConditionalExpr", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ConditionalExpr_913EC12A62708AAC7AE3164F4D215F0C8748F8BC.html" }];
    drawDiagram(classes);
}
