...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::SizeOfExpr", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_SizeOfExpr_77497C49764C5BF15A9258FE3A5E694F5BDE6E1A.html" }];
    drawDiagram(classes);
}
