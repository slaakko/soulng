...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::EndIfStatement", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_EndIfStatement_1603A505507BDD95D04236380F979DDEA4DA1E19.html" }];
    drawDiagram(classes);
}
