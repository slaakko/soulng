...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::cppcode::IfStatement", id: "class_3", level: 3, subject: true, hasDerivedClasses: false, link: "./class_IfStatement_AB9F5B9F493F65021C1688318BEDE8429B3C7BEE.html" }];
    drawDiagram(classes);
}
