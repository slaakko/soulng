...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::AlternativeParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_AlternativeParser_F2503F49391CBDD8B06268C0063EFE4CFE71B4AC.html" }];
    drawDiagram(classes);
}
