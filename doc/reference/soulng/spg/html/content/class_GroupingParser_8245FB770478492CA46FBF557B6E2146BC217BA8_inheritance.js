...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::GroupingParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_GroupingParser_8245FB770478492CA46FBF557B6E2146BC217BA8.html" }];
    drawDiagram(classes);
}
