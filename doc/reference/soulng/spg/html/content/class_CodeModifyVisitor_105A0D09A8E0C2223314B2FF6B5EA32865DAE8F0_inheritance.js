...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::CodeModifyVisitor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CodeModifyVisitor_105A0D09A8E0C2223314B2FF6B5EA32865DAE8F0.html" }];
    drawDiagram(classes);
}
