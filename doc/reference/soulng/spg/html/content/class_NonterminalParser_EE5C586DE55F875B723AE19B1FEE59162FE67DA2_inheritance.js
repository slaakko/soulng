...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::NonterminalParser", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_NonterminalParser_EE5C586DE55F875B723AE19B1FEE59162FE67DA2.html" }];
    drawDiagram(classes);
}
