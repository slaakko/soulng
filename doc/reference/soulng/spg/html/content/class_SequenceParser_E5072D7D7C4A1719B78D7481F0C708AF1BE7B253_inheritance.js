...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::SequenceParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_SequenceParser_E5072D7D7C4A1719B78D7481F0C708AF1BE7B253.html" }];
    drawDiagram(classes);
}
