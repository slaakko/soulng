...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::KleeneParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_KleeneParser_311292922CFBF0B9743ECECCF7E2AEFE89DAF3AF.html" }];
    drawDiagram(classes);
}
