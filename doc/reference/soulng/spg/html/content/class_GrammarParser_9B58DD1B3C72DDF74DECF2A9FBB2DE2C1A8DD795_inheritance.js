...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::GrammarParser", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_GrammarParser_9B58DD1B3C72DDF74DECF2A9FBB2DE2C1A8DD795.html" }];
    drawDiagram(classes);
}
