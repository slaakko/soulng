...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::CharSetParser", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CharSetParser_B6ECE7C272FD123E9CA2B19F60F55F3C157AA96F.html" }];
    drawDiagram(classes);
}
