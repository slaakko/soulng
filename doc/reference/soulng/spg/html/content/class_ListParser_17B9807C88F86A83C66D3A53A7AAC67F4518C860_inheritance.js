...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::ListParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ListParser_17B9807C88F86A83C66D3A53A7AAC67F4518C860.html" }];
    drawDiagram(classes);
}
