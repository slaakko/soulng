...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::CodeGeneratorVisitor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CodeGeneratorVisitor_DA9381F593E316EFF2E7BBA65C60004D3E52EC17.html" }];
    drawDiagram(classes);
}
