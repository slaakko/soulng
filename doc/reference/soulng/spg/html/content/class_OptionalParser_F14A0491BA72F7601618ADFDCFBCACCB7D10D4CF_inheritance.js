...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::OptionalParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_OptionalParser_F14A0491BA72F7601618ADFDCFBCACCB7D10D4CF.html" }];
    drawDiagram(classes);
}
