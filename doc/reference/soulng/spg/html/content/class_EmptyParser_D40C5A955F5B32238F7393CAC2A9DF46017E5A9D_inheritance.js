...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::EmptyParser", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_EmptyParser_D40C5A955F5B32238F7393CAC2A9DF46017E5A9D.html" }];
    drawDiagram(classes);
}
