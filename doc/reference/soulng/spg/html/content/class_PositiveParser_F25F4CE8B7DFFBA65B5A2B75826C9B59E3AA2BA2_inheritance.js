...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::PositiveParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_PositiveParser_F25F4CE8B7DFFBA65B5A2B75826C9B59E3AA2BA2.html" }];
    drawDiagram(classes);
}
