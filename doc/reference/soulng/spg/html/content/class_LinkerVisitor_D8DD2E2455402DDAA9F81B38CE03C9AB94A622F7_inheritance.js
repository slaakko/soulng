...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::LinkerVisitor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_LinkerVisitor_D8DD2E2455402DDAA9F81B38CE03C9AB94A622F7.html" }];
    drawDiagram(classes);
}
