...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::DifferenceParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DifferenceParser_35A5A3788984C8AC50172322EE8876A95F7F4251.html" }];
    drawDiagram(classes);
}
