...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::CodeEvaluationVisitor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CodeEvaluationVisitor_48C73911560ADAACDCF3CE10B8486A9688A2E9A2.html" }];
    drawDiagram(classes);
}
