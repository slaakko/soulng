...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "soulng::cppcode::Visitor", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./../../../cppcode/html/content/class_Visitor_C08EC075809566FD8B9F1F6E313DFA554E17E838.html" },
        { name: "soulng::spg::NonterminalCountingVisitor", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_NonterminalCountingVisitor_28389D450BCF911828B848FF637A432B431A0828.html" }];
    drawDiagram(classes);
}
