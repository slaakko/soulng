...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "soulng::spg::CharParser", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CharParser_E21B8AB860B10B1FCE8DC9CBD13594992CF75A28.html" }];
    drawDiagram(classes);
}
