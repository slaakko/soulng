...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sng2html::sng2html::DifferenceParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_DifferenceParser_96147229580E48887A7D7790B1D602BFA93309B4.html" }];
    drawDiagram(classes);
}
