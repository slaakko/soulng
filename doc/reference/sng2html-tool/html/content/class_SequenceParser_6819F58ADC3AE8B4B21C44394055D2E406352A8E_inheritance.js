...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sng2html::sng2html::SequenceParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_SequenceParser_6819F58ADC3AE8B4B21C44394055D2E406352A8E.html" }];
    drawDiagram(classes);
}
