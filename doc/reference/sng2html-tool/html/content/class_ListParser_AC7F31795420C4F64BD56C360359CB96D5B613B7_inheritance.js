...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sng2html::sng2html::ListParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_ListParser_AC7F31795420C4F64BD56C360359CB96D5B613B7.html" }];
    drawDiagram(classes);
}
