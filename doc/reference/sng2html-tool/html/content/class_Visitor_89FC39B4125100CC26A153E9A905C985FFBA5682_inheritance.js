...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "sng2html::sng2html::Visitor", id: "class_0", level: 0, subject: true, hasDerivedClasses: true, link: "./class_Visitor_89FC39B4125100CC26A153E9A905C985FFBA5682.html" },
        { name: "sng2html::sng2html::GrammarHtmlGeneratorVisitor", id: "class_1", level: 1, subject: false, hasDerivedClasses: false, link: "./class_GrammarHtmlGeneratorVisitor_5B9B5F1EA0A43DDFAA449C1787213B9C16781EF8.html" },
        { name: "sng2html::sng2html::LinkerVisitor", id: "class_2", level: 1, subject: false, hasDerivedClasses: false, link: "./class_LinkerVisitor_048D2F52C8E195D4C7F60D2BEAE9D0CE67C45BDC.html" }];
    drawDiagram(classes);
}
