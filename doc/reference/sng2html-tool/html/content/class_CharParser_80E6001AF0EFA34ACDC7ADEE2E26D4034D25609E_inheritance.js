...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sng2html::sng2html::CharParser", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_CharParser_80E6001AF0EFA34ACDC7ADEE2E26D4034D25609E.html" }];
    drawDiagram(classes);
}
