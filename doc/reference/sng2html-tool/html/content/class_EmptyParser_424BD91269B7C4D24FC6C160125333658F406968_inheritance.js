...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sng2html::sng2html::EmptyParser", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_EmptyParser_424BD91269B7C4D24FC6C160125333658F406968.html" }];
    drawDiagram(classes);
}
