...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sng2html::sng2html::PositiveParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_PositiveParser_5E32A3A08A39DB1CB88573C256F327DF5A7416D4.html" }];
    drawDiagram(classes);
}
