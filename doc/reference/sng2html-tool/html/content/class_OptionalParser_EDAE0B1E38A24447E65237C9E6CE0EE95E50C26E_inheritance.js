...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sng2html::sng2html::OptionalParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_OptionalParser_EDAE0B1E38A24447E65237C9E6CE0EE95E50C26E.html" }];
    drawDiagram(classes);
}
