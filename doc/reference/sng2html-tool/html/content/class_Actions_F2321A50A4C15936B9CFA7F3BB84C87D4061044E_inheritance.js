...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sng2html::sng2html::Actions", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_Actions_F2321A50A4C15936B9CFA7F3BB84C87D4061044E.html" }];
    drawDiagram(classes);
}
