...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sng2html::sng2html::RefExpr", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_RefExpr_16C5A045CCAD7CE6DC1F85B91C31CC895EAFA255.html" }];
    drawDiagram(classes);
}
