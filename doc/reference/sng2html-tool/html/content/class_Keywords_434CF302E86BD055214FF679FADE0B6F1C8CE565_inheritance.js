...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sng2html::sng2html::Keywords", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./class_Keywords_434CF302E86BD055214FF679FADE0B6F1C8CE565.html" }];
    drawDiagram(classes);
}
