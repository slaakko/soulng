...
function drawClassInheritanceDiagram() {
    var classes = [
        ...
        { name: "sng2html::sng2html::AlternativeParser", id: "class_2", level: 2, subject: true, hasDerivedClasses: false, link: "./class_AlternativeParser_FC07998B25E3D9C5C4B24B5096138168E1B12B77.html" }];
    drawDiagram(classes);
}
