...
function drawClassInheritanceDiagram() {
    var classes = [
        { name: "sng2html::sng2html::Parameter", id: "class_0", level: 0, subject: false, hasDerivedClasses: true, link: "./struct_Parameter_CADCFCE7A41FE60A7A30AB511B303C0C83E4D780.html" },
        { name: "sng2html::sng2html::Variable", id: "class_1", level: 1, subject: true, hasDerivedClasses: false, link: "./struct_Variable_97A7FF0F428D0233628AA66BDDE9D4613224D0A3.html" }];
    drawDiagram(classes);
}
