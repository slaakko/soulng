#ifndef BOOKSHELF_HPP_7B2C447D211280EBCC6F835FE5C10ECB47B5432B
#define BOOKSHELF_HPP_7B2C447D211280EBCC6F835FE5C10ECB47B5432B
...
class Bookshelf : public sngxml::xmlser::XmlSerializable
{
public:
    Bookshelf();
...
public:
    ...
    std::vector<unique_xml_ptr<Author>> authors;
    std::vector<unique_xml_ptr<Book>> books;
    void* dataPtr;
private:
    static int classId;
...
#endif // BOOKSHELF_HPP_7B2C447D211280EBCC6F835FE5C10ECB47B5432B
