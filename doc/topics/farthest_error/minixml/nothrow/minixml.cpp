...
// this file has been automatically generated from 'C:/work/soulng/doc/topics/farthest_error/minixml/nothrow/minixml.parser' using soulng parser generator spg version 3.1.0
...
void minixml::Parse(TrivialLexer& lexer)
{
    ...
    {
        lexer.AddError(span, U"document");
        return;
    }
    return;
}
