#include "LexerFile.hpp"
#include <soulng/util/Unicode.hpp>
#include <soulng/slg/CppDeclarator.hpp>
#include <soulng/slg/CppStatement.hpp>
...
std::unique_ptr<soulng::slg::LexerFile> LexerFileParser::Parse(LexerFileLexer& lexer)
{
    ...
    {
        lexer.ThrowExpectationFailure(pos, U"LexerFile");
    }
    return value;
}
        ...
        if (match.hit)
        {
            ...
            soulng::parser::Match* parentMatch5 = &match;
            {
                soulng::parser::Match match(true);
                {
                    ...
                    if (!match.hit)
                    {
                        lexer.ThrowExpectationFailure(pos, U"ExprString");
                    }
                }
                *parentMatch5 = match;
            }
    ...
    if (match.hit)
    {
        ...
        soulng::parser::Match* parentMatch6 = &match;
        {
            ...
            soulng::parser::Match* parentMatch7 = &match;
            {
                ...
                if (match.hit)
                {
                    return soulng::parser::Match(true, new soulng::slg::Expression(index, exprName, exprValue->value));
                }
                *parentMatch7 = match;
            }
            *parentMatch6 = match;
    ...
    soulng::parser::Match* parentMatch0 = &match;
    {
        ...
        soulng::parser::Match* parentMatch1 = &match;
        {
            ...
            soulng::parser::Match* parentMatch2 = &match;
            {
                ...
                if (match.hit)
                {
                    currentLexer->AddStatement(new soulng::slg::LexerStatement(expr->value, stmt.release(), action->value));
                }
                *parentMatch2 = match;
            }
            *parentMatch1 = match;
