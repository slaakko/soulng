#include "CppExpression.hpp"
#include <soulng/util/Unicode.hpp>
#include <soulng/util/TextUtils.hpp>
#include <soulng/slg/CppDeclarator.hpp>
#include <soulng/slg/CppDeclaration.hpp>
#include <soulng/slg/CppLiteral.hpp>
#include <soulng/slg/CppIdentifier.hpp>
#include <soulng/slg/LexerFileLexer.hpp>
#include <soulng/slg/LexerFileTokens.hpp>

// this file has been automatically generated from 'D:/work/soulng/slg/CppExpression.parser' using soulng parser generator spg version 1.0.0
                ...
                soulng::parser::Match* parentMatch5 = &match;
                {
                    ...
                    soulng::parser::Match* parentMatch6 = &match;
                    {
                        ...
                        soulng::parser::Match match(true);
                        {
                            ...
                            if (!match.hit)
                            {
                                lexer.ThrowExpectationFailure(pos, U"AssignmentExpression");
                            }
                        }
                        if (match.hit)
                        {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        soulng::parser::Match match(true);
                                        {
                                            ...
                                            if (!match.hit)
                                            {
                                                lexer.ThrowExpectationFailure(pos, U"LogicalAndExpression");
                                            }
                                        }
                                        if (match.hit)
                                        {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        soulng::parser::Match match(true);
                                        {
                                            ...
                                            if (!match.hit)
                                            {
                                                lexer.ThrowExpectationFailure(pos, U"InclusiveOrExpression");
                                            }
                                        }
                                        if (match.hit)
                                        {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        soulng::parser::Match match(true);
                                        {
                                            ...
                                            if (!match.hit)
                                            {
                                                lexer.ThrowExpectationFailure(pos, U"ExclusiveOrExpression");
                                            }
                                        }
                                        if (match.hit)
                                        {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        soulng::parser::Match match(true);
                                        {
                                            ...
                                            if (!match.hit)
                                            {
                                                lexer.ThrowExpectationFailure(pos, U"AndExpression");
                                            }
                                        }
                                        if (match.hit)
                                        {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        soulng::parser::Match match(true);
                                        {
                                            ...
                                            if (!match.hit)
                                            {
                                                lexer.ThrowExpectationFailure(pos, U"EqualityExpression");
                                            }
                                        }
                                        if (match.hit)
                                        {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        soulng::parser::Match match(true);
                                        {
                                            ...
                                            if (!match.hit)
                                            {
                                                lexer.ThrowExpectationFailure(pos, U"ShiftExpression");
                                            }
                                        }
                                        if (match.hit)
                                        {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        soulng::parser::Match match(true);
                                        {
                                            ...
                                            if (!match.hit)
                                            {
                                                lexer.ThrowExpectationFailure(pos, U"PmExpression");
                                            }
                                        }
                                        if (match.hit)
                                        {
                                ...
                                soulng::parser::Match* parentMatch6 = &match;
                                {
                                    ...
                                    soulng::parser::Match* parentMatch7 = &match;
                                    {
                                        ...
                                        soulng::parser::Match match(true);
                                        {
                                            ...
                                            if (!match.hit)
                                            {
                                                lexer.ThrowExpectationFailure(pos, U"CastExpression");
                                            }
                                        }
                                        if (match.hit)
                                        {
                                    ...
                                    if (match.hit)
                                    {
                                        ...
                                        soulng::parser::Match* parentMatch29 = &match;
                                        {
                                            soulng::parser::Match match(true);
                                            {
                                                ...
                                                if (!match.hit)
                                                {
                                                    lexer.ThrowExpectationFailure(pos, U"TypeId");
                                                }
                                            }
                                            *parentMatch29 = match;
                                        }
                                                            ...
                                                            soulng::parser::Match* parentMatch25 = &match;
                                                            {
                                                                ...
                                                                soulng::parser::Match* parentMatch26 = &match;
                                                                {
                                                                    ...
                                                                    soulng::parser::Match match(true);
                                                                    {
                                                                        ...
                                                                        if (!match.hit)
                                                                        {
                                                                            lexer.ThrowExpectationFailure(pos, U"IdExpression");
                                                                        }
                                                                    }
                                                                    if (match.hit)
                                                                    {
