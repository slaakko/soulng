...
soulng::codedom::InitDeclaratorList* Declarator::Parse(const char32_t* start, const char32_t* end, int fileIndex, const std::string& fileName)
{
    ...
    soulng::codedom::InitDeclaratorList* result = *static_cast<soulng::parsing::ValueObject<soulng::codedom::InitDeclaratorList*>*>(value.get());
    stack.pop();
    return result;
}
...
public:
    ...
    {
        SetValueTypeName(ToUtf32("soulng::codedom::InitDeclaratorList*"));
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::InitDeclaratorList*>(context->value)));
        }
    ...
    void PostInitDeclarator(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromInitDeclarator = *static_cast<soulng::parsing::ValueObject<soulng::codedom::InitDeclarator*>*>(fromInitDeclarator_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::InitDeclaratorList* value;
        std::unique_ptr<InitDeclaratorList> idl;
        soulng::codedom::InitDeclarator* fromInitDeclarator;
    };
};
...
public:
    InitDeclaratorRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::InitDeclarator*"));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::InitDeclarator*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    ...
    void PostInitializer(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromInitializer = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Initializer*>*>(fromInitializer_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::InitDeclarator* value;
        std::u32string fromDeclarator;
        soulng::codedom::Initializer* fromInitializer;
    };
};
...
public:
    TypeRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::Type*"));
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::Type*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
...
public:
    TypeSpecifierSeqRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        AddInheritedAttribute(AttrOrVariable(ToUtf32("soulng::codedom::TypeId*"), ToUtf32("typeId")));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
        ...
        context->typeId = *static_cast<soulng::parsing::ValueObject<soulng::codedom::TypeId*>*>(typeId_value.get());
        stack.pop();
    }
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
...
public:
    InitializerRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::Initializer*"));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::Initializer*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    {
        ...
        expressionListNonterminalParser->SetPostCall(new soulng::parsing::MemberPostCall<InitializerRule>(this, &InitializerRule::PostExpressionList));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
    ...
    void PostInitializerClause(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromInitializerClause = *static_cast<soulng::parsing::ValueObject<soulng::codedom::AssignInit*>*>(fromInitializerClause_value.get());
            stack.pop();
        }
    }
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Initializer* value;
        soulng::codedom::AssignInit* fromInitializerClause;
...
public:
    InitializerClauseRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::AssignInit*"));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::AssignInit*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::AssignInit* value;
...
public:
    InitializerListRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        AddInheritedAttribute(AttrOrVariable(ToUtf32("soulng::codedom::AssignInit*"), ToUtf32("init")));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
        ...
        context->init = *static_cast<soulng::parsing::ValueObject<soulng::codedom::AssignInit*>*>(init_value.get());
        stack.pop();
    }
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::AssignInit* init;
        soulng::codedom::AssignInit* fromInitializerClause;
    };
};
...
void Declarator::GetReferencedGrammars()
{
    ...
    soulng::parsing::Grammar* grammar0 = pd->GetGrammar(ToUtf32("soulng.code.Declaration"));
    if (!grammar0)
    {
        grammar0 = soulng::code::Declaration::Create(pd);
    }
