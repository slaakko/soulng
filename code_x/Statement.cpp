...
soulng::codedom::CompoundStatement* Statement::Parse(const char32_t* start, const char32_t* end, int fileIndex, const std::string& fileName)
{
    ...
    soulng::codedom::CompoundStatement* result = *static_cast<soulng::parsing::ValueObject<soulng::codedom::CompoundStatement*>*>(value.get());
    stack.pop();
    return result;
}
...
public:
    ...
    {
        SetValueTypeName(ToUtf32("soulng::codedom::Statement*"));
    }
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::Statement*>(context->value)));
        }
    ...
    void PostLabeledStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromLabeledStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromLabeledStatement_value.get());
            stack.pop();
        }
    }
    void PostEmptyStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromEmptyStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromEmptyStatement_value.get());
            stack.pop();
        }
    }
    void PostCompoundStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromCompoundStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::CompoundStatement*>*>(fromCompoundStatement_value.get());
            stack.pop();
        }
    }
    void PostSelectionStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromSelectionStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromSelectionStatement_value.get());
            stack.pop();
        }
    }
    void PostIterationStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromIterationStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromIterationStatement_value.get());
            stack.pop();
        }
    }
    void PostJumpStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromJumpStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromJumpStatement_value.get());
            stack.pop();
        }
    }
    void PostDeclarationStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromDeclarationStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromDeclarationStatement_value.get());
            stack.pop();
        }
    }
    void PostTryStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromTryStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::TryStatement*>*>(fromTryStatement_value.get());
            stack.pop();
        }
    }
    void PostExpressionStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromExpressionStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromExpressionStatement_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Statement* value;
        soulng::codedom::Statement* fromLabeledStatement;
        soulng::codedom::Statement* fromEmptyStatement;
        soulng::codedom::CompoundStatement* fromCompoundStatement;
        soulng::codedom::Statement* fromSelectionStatement;
        soulng::codedom::Statement* fromIterationStatement;
        soulng::codedom::Statement* fromJumpStatement;
        soulng::codedom::Statement* fromDeclarationStatement;
        soulng::codedom::TryStatement* fromTryStatement;
        soulng::codedom::Statement* fromExpressionStatement;
    };
};
...
public:
    ...
    void Posts1(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->froms1 = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(froms1_value.get());
            stack.pop();
        }
    }
    ...
    void Posts2(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->froms2 = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(froms2_value.get());
            stack.pop();
        }
    }
    void Posts3(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->froms3 = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(froms3_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Statement* froms1;
        soulng::codedom::CppObject* fromConstantExpression;
        soulng::codedom::Statement* froms2;
        soulng::codedom::Statement* froms3;
    };
};
...
public:
    CompoundStatementRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::CompoundStatement*"));
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::CompoundStatement*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    ...
    void PostStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromStatement_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::CompoundStatement* value;
        std::unique_ptr<CompoundStatement> cs;
        soulng::codedom::Statement* fromStatement;
    };
};
...
public:
    ...
    void PostIfStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromIfStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromIfStatement_value.get());
            stack.pop();
        }
    }
    void PostSwitchStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromSwitchStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromSwitchStatement_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Statement* value;
        soulng::codedom::Statement* fromIfStatement;
        soulng::codedom::Statement* fromSwitchStatement;
    };
};
...
public:
    ...
    void PostCondition(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromCondition = *static_cast<soulng::parsing::ValueObject<soulng::codedom::CppObject*>*>(fromCondition_value.get());
            stack.pop();
        }
    }
    void PostthenStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromthenStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromthenStatement_value.get());
            stack.pop();
        }
    }
    void PostelseStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromelseStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromelseStatement_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Statement* value;
        soulng::codedom::CppObject* fromCondition;
        soulng::codedom::Statement* fromthenStatement;
        soulng::codedom::Statement* fromelseStatement;
    };
};
...
public:
    ...
    void PostWhileStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromWhileStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromWhileStatement_value.get());
            stack.pop();
        }
    }
    void PostDoStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromDoStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromDoStatement_value.get());
            stack.pop();
        }
    }
    void PostForStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromForStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromForStatement_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Statement* value;
        soulng::codedom::Statement* fromWhileStatement;
        soulng::codedom::Statement* fromDoStatement;
        soulng::codedom::Statement* fromForStatement;
    };
};
...
public:
    ...
    void PostForInitStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromForInitStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::CppObject*>*>(fromForInitStatement_value.get());
            stack.pop();
        }
    }
    void PostCondition(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Statement* value;
        soulng::codedom::CppObject* fromForInitStatement;
        soulng::codedom::CppObject* fromCondition;
        soulng::codedom::CppObject* fromExpression;
        soulng::codedom::Statement* fromStatement;
    };
...
public:
    ...
    void PostSimpleDeclaration(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromSimpleDeclaration = *static_cast<soulng::parsing::ValueObject<soulng::codedom::SimpleDeclaration*>*>(fromSimpleDeclaration_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Statement* fromEmptyStatement;
        soulng::codedom::Statement* fromExpressionStatement;
        soulng::codedom::SimpleDeclaration* fromSimpleDeclaration;
    };
};
...
public:
    ...
    void PostBreakStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromBreakStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromBreakStatement_value.get());
            stack.pop();
        }
    }
    void PostContinueStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromContinueStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromContinueStatement_value.get());
            stack.pop();
        }
    }
    void PostReturnStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromReturnStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromReturnStatement_value.get());
            stack.pop();
        }
    }
    void PostGotoStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromGotoStatement = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Statement*>*>(fromGotoStatement_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Statement* value;
        soulng::codedom::Statement* fromBreakStatement;
        soulng::codedom::Statement* fromContinueStatement;
        soulng::codedom::Statement* fromReturnStatement;
        soulng::codedom::Statement* fromGotoStatement;
    };
};
...
public:
    ...
    void PostBlockDeclaration(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromBlockDeclaration = *static_cast<soulng::parsing::ValueObject<soulng::codedom::CppObject*>*>(fromBlockDeclaration_value.get());
            stack.pop();
        }
    }
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Statement* value;
        soulng::codedom::CppObject* fromBlockDeclaration;
    };
};
...
public:
    TryStatementRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::TryStatement*"));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::TryStatement*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::TryStatement* value;
        soulng::codedom::CompoundStatement* fromCompoundStatement;
    };
};
...
public:
    ...
    void PostHandler(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromHandler = *static_cast<soulng::parsing::ValueObject<soulng::codedom::Handler*>*>(fromHandler_value.get());
            stack.pop();
        }
    }
    void PreHandlerSeq(soulng::parsing::ObjectStack& stack, ParsingData* parsingData)
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        TryStatement* st;
        soulng::codedom::Handler* fromHandler;
    };
};
...
public:
    HandlerRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::Handler*"));
    }
    void Enter(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData) override
    {
        parsingData->PushContext(Id(), new Context());
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::Handler*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    ...
    void PostExceptionDeclaration(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromExceptionDeclaration = *static_cast<soulng::parsing::ValueObject<soulng::codedom::ExceptionDeclaration*>*>(fromExceptionDeclaration_value.get());
            stack.pop();
        }
    }
    void PostCompoundStatement(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::Handler* value;
        soulng::codedom::ExceptionDeclaration* fromExceptionDeclaration;
        soulng::codedom::CompoundStatement* fromCompoundStatement;
    };
};
...
public:
    ExceptionDeclarationRule(const std::u32string& name_, Scope* enclosingScope_, int id_, Parser* definition_):
        soulng::parsing::Rule(name_, enclosingScope_, id_, definition_)
    {
        SetValueTypeName(ToUtf32("soulng::codedom::ExceptionDeclaration*"));
    ...
    void Leave(soulng::parsing::ObjectStack& stack, soulng::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::ExceptionDeclaration*>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    ...
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
        stack.push(std::unique_ptr<soulng::parsing::Object>(new soulng::parsing::ValueObject<soulng::codedom::TypeId*>(context->ed->GetTypeId())));
    }
    void PostDeclarator(soulng::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
private:
    struct Context : soulng::parsing::Context
    {
        ...
        soulng::codedom::ExceptionDeclaration* value;
